package com.ankamagames.dofus.datacenter.breeds
{
   public class Breed
   {
      ...
      public function get breedSpellsId() : Vector.<uint>
      {
         return new Vector.<uint>();
      }
      
      public function get breedRoles() : Vector.<BreedRoleByBreed>
      {
         return new Vector.<BreedRoleByBreed>();
      }
      
      public function get maleColors() : Vector.<uint>
      {
         return new Vector.<uint>();
      }
      
      public function get femaleColors() : Vector.<uint>
      {
         return new Vector.<uint>();
      }
      ...
      public function get breedSpellsWithVariants() : Object
      {
         return null;
      }
