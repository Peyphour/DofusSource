package ui
{
   ...
   public class TextInfoWithHorizontalSeparatorTooltipUi
   {
      ...
      {
         this.lbl_text.text = param1.data.content;
         this.lbl_additionalInfo.text = param1.data.additionalInfo;
         this.lbl_text.fullWidth(param1.data.maxWidth);
         if(param1.data.addInfoCssClass)
         {
            this.lbl_additionalInfo.cssClass = param1.data.addInfoCssClass;
         }
         ...
         this.mainCtr.width = param1.data.maxWidth + 20;
