   ...
   public class GuildCreator
   {
      ...
      public function selectBackground(param1:Object, param2:Boolean) : void
      {
         if(param1 != null)
         {
            ...
            this.tx_emblem.uri = this.uiApi.createUri(this.uiApi.me().getConstant("picto_uri") + "back/" + param1.iconUri.fileName.split(".")[0] + ".swf");
         }
      }
      ...
      {
         var _loc1_:GuildWrapper = null;
         if(this.socialApi.hasGuild())
         {
            _loc1_ = this.socialApi.getGuild();
            if(!this.socialApi.isGuildNameInvalid())
            {
               this.inp_guildname.text = _loc1_.guildName;
            }
      ...
      {
         this.uiApi.showTooltip(this.uiApi.textTooltipInfo(this.uiApi.getText("ui.social.nameRules")),param1,false,"standard",0,0,3,null,null,null,"TextInfo");
      }
      ...
      public function onGuildCreationResult(param1:uint) : void
      {
         switch(param1)
         {
