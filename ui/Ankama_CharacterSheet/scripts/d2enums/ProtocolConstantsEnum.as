package d2enums
{
   public class ProtocolConstantsEnum
   {
      ...
      public static const MAX_PRESTIGE_LEVEL:int = 206;
      ...
      public static const MAX_PRESET_COUNT:int = 16;
      ...
      public static const MAX_CRITERION_BY_DARE:int = 6;
      
      public static const MIN_PLAYERS_FOR_GROUP_IDOLS:int = 3;
      
      public static const MIN_DARE_JACKPOT_VALUE:int = 5000;
      
      public static const DARE_CREATION_TAX:int = 1000;
      
      public static const MIN_DARE_DURATION:int = 1;
      
      public static const MAX_DARE_DURATION:int = 14;
      
      public static const MAX_DARE_WINNERS:int = 5000;
      
      public static const MAX_KAMA:int = 2000000000;
