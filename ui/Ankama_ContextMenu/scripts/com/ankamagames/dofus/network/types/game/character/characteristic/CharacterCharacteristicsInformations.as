package com.ankamagames.dofus.network.types.game.character.characteristic
{
   ...
   public class CharacterCharacteristicsInformations
   {
      ...
      public function get experienceBonusLimit() : Number
      {
         return new Number();
      }
      ...
      public function get spellModifications() : Vector.<CharacterSpellModification>
      {
         return new Vector.<CharacterSpellModification>();
      }
