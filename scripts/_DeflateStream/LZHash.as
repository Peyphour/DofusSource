package _DeflateStream
{
   ...
   public class LZHash
   {
      ...
      public function LZHash(param1:int, param2:int, param3:int)
      {
         ...
         windowSize = param3;
         avgMatchLength = 12;
         var _loc4_:* = param1 + 327700 - 20;
         resultAddr = _loc4_;
         baseResultAddr = _loc4_;
      ...
      public static function hash4(param1:int, param2:int) : int
      {
         ...
         var _loc7_:* = _loc3_ ^ 4;
         _loc7_ = _loc7_ ^ _loc7_ >>> 16;
         _loc7_ = _loc7_ * -2048144789;
         _loc7_ = _loc7_ ^ _loc7_ >>> 13;
         _loc7_ = _loc7_ * -1028477387;
      ...
      public static function murmur_fmix(param1:int) : int
      {
         ...
         param1 = param1 * -2048144789;
         param1 = param1 ^ param1 >>> 13;
         param1 = param1 * -1028477387;
      ...
      public function update(param1:int) : void
      {
         ...
         _loc4_ = _loc4_ ^ _loc7_ * _loc6_;
         _loc4_ = _loc4_ << 13 | _loc4_ >>> 19;
         _loc4_ = _loc4_ * 5 + -430675100;
         _loc8_ = _loc4_ ^ 4;
         _loc8_ = _loc8_ ^ _loc8_ >>> 16;
         _loc8_ = _loc8_ * -2048144789;
         _loc8_ = _loc8_ ^ _loc8_ >>> 13;
         _loc8_ = _loc8_ * -1028477387;
         var _loc3_:* = (_loc8_ ^ _loc8_ >>> 16) & 65535;
         var _loc2_:* = addr + _loc3_ * 5;
         _loc3_ = 4;
         _loc4_ = int(param1);
         _loc5_ = li8(_loc2_);
         if(_loc5_ < 8 && _loc5_ >= 0)
         {
            ...
            _loc12_ = _loc12_ ^ _loc12_ >>> 16;
            _loc12_ = _loc12_ * -2048144789;
            _loc12_ = _loc12_ ^ _loc12_ >>> 13;
            _loc12_ = _loc12_ * -1028477387;
      ...
      public function unsafeSearchAndUpdate(param1:int) : void
      {
         ...
         _loc5_ = _loc5_ ^ _loc8_ * _loc7_;
         _loc5_ = _loc5_ << 13 | _loc5_ >>> 19;
         _loc5_ = _loc5_ * 5 + -430675100;
         _loc9_ = _loc5_ ^ 4;
         _loc9_ = _loc9_ ^ _loc9_ >>> 16;
         _loc9_ = _loc9_ * -2048144789;
         _loc9_ = _loc9_ ^ _loc9_ >>> 13;
         _loc9_ = _loc9_ * -1028477387;
         ...
         if(li16(baseResultAddr + (resultAddr - baseResultAddr + 4 & 7)) < avgMatchLength + 4)
         {
            ...
            while(_loc10_ < _loc11_)
            {
               ...
               _loc15_ = _loc15_ ^ _loc18_ * _loc17_;
               ...
               _loc19_ = _loc19_ ^ _loc19_ >>> 16;
               _loc19_ = _loc19_ * -2048144789;
               _loc19_ = _loc19_ ^ _loc19_ >>> 13;
               _loc19_ = _loc19_ * -1028477387;
         ...
         if(_loc7_ < 8 && _loc7_ >= 0)
         {
            ...
            _loc10_ = _loc10_ ^ _loc13_ * _loc12_;
            ...
            _loc14_ = _loc14_ ^ _loc14_ >>> 16;
            _loc14_ = _loc14_ * -2048144789;
            _loc14_ = _loc14_ ^ _loc14_ >>> 13;
            _loc14_ = _loc14_ * -1028477387;
            ...
            else
            {
               ...
               if(_loc2_ < avgMatchLength + 4)
               {
                  ...
                  while(_loc4_ < _loc5_)
                  {
                     ...
                     _loc13_ = _loc13_ ^ _loc16_ * _loc15_;
                     _loc13_ = _loc13_ << 13 | _loc13_ >>> 19;
                     _loc13_ = _loc13_ * 5 + -430675100;
                     _loc17_ = _loc13_ ^ 4;
                     _loc17_ = _loc17_ ^ _loc17_ >>> 16;
                     _loc17_ = _loc17_ * -2048144789;
                     _loc17_ = _loc17_ ^ _loc17_ >>> 13;
                     _loc17_ = _loc17_ * -1028477387;
                     _loc12_ = (_loc17_ ^ _loc17_ >>> 16) & 65535;
                     _loc11_ = addr + _loc12_ * 5;
                     _loc9_ = int(li8(_loc11_));
                     if(_loc9_ < 8 && _loc9_ >= 0)
                     {
               ...
               _loc7_ = _loc7_ ^ _loc10_ * _loc9_;
               _loc7_ = _loc7_ << 13 | _loc7_ >>> 19;
               _loc7_ = _loc7_ * 5 + -430675100;
               _loc11_ = _loc7_ ^ 4;
               _loc11_ = _loc11_ ^ _loc11_ >>> 16;
               _loc11_ = _loc11_ * -2048144789;
               _loc11_ = _loc11_ ^ _loc11_ >>> 13;
               _loc11_ = _loc11_ * -1028477387;
               ...
               while(_loc11_ < _loc12_)
               {
                  ...
                  _loc16_ = _loc16_ ^ _loc19_ * _loc18_;
                  ...
                  _loc20_ = _loc20_ ^ _loc20_ >>> 16;
                  _loc20_ = _loc20_ * -2048144789;
                  _loc20_ = _loc20_ ^ _loc20_ >>> 13;
                  _loc20_ = _loc20_ * -1028477387;
               ...
               if(_loc9_ < 8 && _loc9_ >= 0)
               {
                  ...
                  _loc12_ = _loc12_ ^ _loc15_ * _loc14_;
                  ...
                  _loc16_ = _loc16_ ^ _loc16_ >>> 16;
                  _loc16_ = _loc16_ * -2048144789;
                  _loc16_ = _loc16_ ^ _loc16_ >>> 13;
                  _loc16_ = _loc16_ * -1028477387;
      ...
      public function unsafeInitLookahead(param1:int) : void
      {
         ...
         if(_loc6_ < 8 && _loc6_ >= 0)
         {
            ...
            _loc13_ = _loc13_ ^ _loc13_ >>> 16;
            _loc13_ = _loc13_ * -2048144789;
            _loc13_ = _loc13_ ^ _loc13_ >>> 13;
            _loc13_ = _loc13_ * -1028477387;
      ...
      public function searchAndUpdate(param1:int, param2:int) : void
      {
         ...
         _loc6_ = _loc6_ ^ _loc9_ * _loc8_;
         _loc6_ = _loc6_ << 13 | _loc6_ >>> 19;
         _loc6_ = _loc6_ * 5 + -430675100;
         _loc10_ = _loc6_ ^ 4;
         _loc10_ = _loc10_ ^ _loc10_ >>> 16;
         _loc10_ = _loc10_ * -2048144789;
         _loc10_ = _loc10_ ^ _loc10_ >>> 13;
         _loc10_ = _loc10_ * -1028477387;
         ...
         if(_loc8_ < 8 && _loc8_ >= 0)
         {
            ...
            _loc11_ = _loc11_ ^ _loc14_ * _loc13_;
            ...
            _loc15_ = _loc15_ ^ _loc15_ >>> 16;
            _loc15_ = _loc15_ * -2048144789;
            _loc15_ = _loc15_ ^ _loc15_ >>> 13;
            _loc15_ = _loc15_ * -1028477387;
            ...
            else if(param1 + _loc3_ + 9 < param2)
            {
               if(_loc3_ < avgMatchLength + 4)
               {
                  ...
                  while(_loc5_ < _loc6_)
                  {
                     ...
                     _loc14_ = _loc14_ ^ _loc17_ * _loc16_;
                     _loc14_ = _loc14_ << 13 | _loc14_ >>> 19;
                     _loc14_ = _loc14_ * 5 + -430675100;
                     _loc18_ = _loc14_ ^ 4;
                     _loc18_ = _loc18_ ^ _loc18_ >>> 16;
                     _loc18_ = _loc18_ * -2048144789;
                     _loc18_ = _loc18_ ^ _loc18_ >>> 13;
                     _loc18_ = _loc18_ * -1028477387;
                     _loc13_ = (_loc18_ ^ _loc18_ >>> 16) & 65535;
                     _loc12_ = addr + _loc13_ * 5;
                     _loc10_ = int(li8(_loc12_));
                     if(_loc10_ < 8 && _loc10_ >= 0)
                     {
               ...
               while(_loc12_ < _loc13_)
               {
                  ...
                  _loc17_ = _loc17_ ^ _loc20_ * _loc19_;
                  ...
                  _loc21_ = _loc21_ ^ _loc21_ >>> 16;
                  _loc21_ = _loc21_ * -2048144789;
                  _loc21_ = _loc21_ ^ _loc21_ >>> 13;
                  _loc21_ = _loc21_ * -1028477387;
      ...
      public function fastUpdate(param1:int) : void
      {
         ...
         var _loc4_:int = li8(_loc6_);
         if(_loc4_ < 8 && _loc4_ >= 0)
         {
