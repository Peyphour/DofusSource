      ...
      public static function weightedAlphabetToCodes(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc15_)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               _loc8_++;
               _loc9_ = int(_loc8_);
               _loc16_ = Number(_loc16_ + Number(Math.pow(2,-li32(param1 + (_loc9_ << 2)))));
            }
            _loc8_ = 0;
            while(_loc16_ > 1 && _loc8_ < _loc7_)
            {
               while(li32(param1 + (_loc8_ << 2)) < param3 && _loc16_ > 1)
               {
                  ...
                  _loc16_ = _loc16_ - Math.pow(2,-li32(param1 + (_loc8_ << 2)));
               }
               _loc8_++;
            }
            _loc8_ = _loc7_ - 1;
            while(_loc8_ >= 0)
            {
               ...
               {
                  _loc16_ = Number(_loc16_ + Number(Math.pow(2,-li32(param1 + (_loc8_ << 2)))));
                  _loc9_ = li32(param1 + (_loc8_ << 2)) - 1;
                  si32(_loc9_,param1 + (_loc8_ << 2));
               }
               _loc8_--;
      ...
      public static function _weightedAlphabetToCodes(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc14_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               _loc7_++;
               _loc8_ = int(_loc7_);
               _loc15_ = Number(_loc15_ + Number(Math.pow(2,-li32(param1 + (_loc8_ << 2)))));
            }
            _loc7_ = 0;
            while(_loc15_ > 1 && _loc7_ < _loc6_)
            {
               while(li32(param1 + (_loc7_ << 2)) < param3 && _loc15_ > 1)
               {
                  ...
                  _loc15_ = _loc15_ - Math.pow(2,-li32(param1 + (_loc7_ << 2)));
               }
               _loc7_++;
            }
            _loc7_ = _loc6_ - 1;
            while(_loc7_ >= 0)
            {
               ...
               {
                  _loc15_ = Number(_loc15_ + Number(Math.pow(2,-li32(param1 + (_loc7_ << 2)))));
                  _loc8_ = li32(param1 + (_loc7_ << 2)) - 1;
                  si32(_loc8_,param1 + (_loc7_ << 2));
               }
               _loc7_--;
      ...
      public static function limitCodeLengths(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               _loc6_++;
               _loc7_ = int(_loc6_);
               _loc8_ = Number(_loc8_ + Number(Math.pow(2,-li32(param1 + (_loc7_ << 2)))));
            }
            _loc6_ = 0;
            while(_loc8_ > 1 && _loc6_ < _loc5_)
            {
               while(li32(param1 + (_loc6_ << 2)) < param3 && _loc8_ > 1)
               {
                  ...
                  _loc8_ = _loc8_ - Math.pow(2,-li32(param1 + (_loc6_ << 2)));
               }
               _loc6_++;
            }
            _loc6_ = _loc5_ - 1;
            while(_loc6_ >= 0)
            {
               ...
               {
                  _loc8_ = Number(_loc8_ + Number(Math.pow(2,-li32(param1 + (_loc6_ << 2)))));
                  _loc7_ = li32(param1 + (_loc6_ << 2)) - 1;
                  si32(_loc7_,param1 + (_loc6_ << 2));
               }
               _loc6_--;
