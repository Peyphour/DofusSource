package
{
   ...
   public class PNGEncoder2 extends EventDispatcher
   {
      ...
      protected var png#8408:ByteArray;
      ...
      public static function encode(param1:BitmapData) : ByteArray
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            _loc8_.position = uint(_loc8_.position + _loc7_);
         }
         _loc9_ = -1;
         ...
         if(_loc6_ != 0)
         {
            ...
            _loc3_.position = uint(_loc3_.position + _loc6_);
         }
         _loc7_ = -1;
      ...
      public function get png#6905() : ByteArray
      {
         return __impl.png#6905;
      }
   }
