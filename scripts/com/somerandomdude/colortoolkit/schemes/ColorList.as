package com.somerandomdude.colortoolkit.schemes
{
   ...
   public dynamic class ColorList extends Array
   {
      ...
      public function toRGB() : ColorList
      {
         ...
         {
            _loc2_.color = this[_loc3_] is IColorSpace?int(this[_loc3_].color):int(this[_loc3_]);
      ...
      public function toColor() : ColorList
      {
         ...
         while(_loc3_ < this.length)
         {
            _loc1_.push(new Color(this[_loc3_] is IColorSpace?int(this[_loc3_].color):int(this[_loc3_])));
            _loc3_++;
         }
         return _loc1_;
      }
