package com.ankamagames.tubul
{
   ...
   public class Tubul extends EventDispatcher
   {
      ...
      private function setVolumeToBus(param1:int, param2:uint = 404) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(param2 != 404)
            {
               _loc3_.volume = param2 * this._globaVolume / 100;
            }
            else
            {
               _loc3_.volume = _loc3_.volume * this._globaVolume / 100;
            }
         }
      }
      ...
      private function onPropertyChanged(param1:PropertyChangeEvent) : void
      {
         ...
         {
            case "muteMusic":
               this.setVolumeToBus(0,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeMusic));
               break;
            case "muteSound":
               this.setVolumeToBus(4,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeSound));
               break;
            case "muteAmbientSound":
               this.setVolumeToBus(1,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(2,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(3,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(5,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(6,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(7,!!param1.propertyValue?uint(0):uint(this._tuOptions.volumeAmbientSound));
               break;
            case "volumeMusic":
            ...
            case "volumeAmbientSound":
               ...
               break;
            case "globalVolume":
               this._globaVolume = param1.propertyValue;
