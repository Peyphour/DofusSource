package com.ankamagames.berilia.uiRender
{
   ...
   public class UiRenderer extends EventDispatcher
   {
      ...
      public function uiRender(param1:UiDefinition, param2:String, param3:UiRootContainer, param4:* = null) : void
      {
         ...
         this.scriptTime = param3.scriptTime;
      ...
      private function makeModalContainer() : void
      {
         ...
         size.setX(StageShareManager.stageLogicalBounds.width,GraphicSize.SIZE_PIXEL);
         size.setY(StageShareManager.stageLogicalBounds.height,GraphicSize.SIZE_PIXEL);
         var anchors:GraphicLocation = new GraphicLocation();
         anchors.offsetXType = LocationTypeEnum.LOCATION_TYPE_ABSOLUTE;
         anchors.setOffsetX(StageShareManager.stageLogicalBounds.x);
         anchors.offsetYType = LocationTypeEnum.LOCATION_TYPE_ABSOLUTE;
         anchors.setOffsetY(StageShareManager.stageLogicalBounds.y);
