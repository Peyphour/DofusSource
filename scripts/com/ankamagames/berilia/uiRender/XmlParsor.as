package com.ankamagames.berilia.uiRender
{
   ...
   public class XmlParsor extends EventDispatcher
   {
      ...
      protected function parseMainNode(param1:XMLNode) : UiDefinition
      {
         ...
         var _loc13_:String = _loc4_[XmlAttributesEnum.ATTRIBUTE_FULLSCREEN];
         if(_loc5_)
         {
         ...
         if(_loc13_)
         {
            _loc2_.fullscreen = _loc13_ == "true";
         }
         var _loc15_:int = _loc3_.length;
         this._glPoint = new GraphicLocation();
         _loc16_ = 0;
         while(_loc16_ < _loc15_)
         {
            _loc14_ = _loc3_[_loc16_];
            switch(_loc14_.nodeName)
            {
               case XmlTagsEnum.TAG_CONSTANTS:
                  this.parseConstants(_loc14_,_loc2_.constants);
                  break;
               ...
               case XmlTagsEnum.TAG_BUTTON:
                  _loc17_ = this.parseGraphicElement(_loc14_);
                  if(_loc17_)
                  {
                     _loc2_.graphicTree.push(_loc17_);
                  }
                  break;
               case XmlTagsEnum.TAG_SHORTCUTS:
                  _loc2_.shortcutsEvents = this.parseShortcutsEvent(_loc14_);
                  break;
               default:
                  _loc18_ = "";
                  if(_loc14_ && _loc14_.nodeName)
                  {
                     _loc18_ = this.suggest(_loc14_.nodeName,[XmlTagsEnum.TAG_CONTAINER,XmlTagsEnum.TAG_STATECONTAINER,XmlTagsEnum.TAG_BUTTON,XmlTagsEnum.TAG_SHORTCUTS]);
                  }
                  this._log.warn("[" + this._sUrl + "] " + _loc14_.nodeName + " is not allowed or unknown. " + _loc18_);
            }
            _loc16_ = _loc16_ + 1;
         }
      ...
      protected function parseGraphicElement(param1:XMLNode, param2:XMLNode = null, param3:BasicElement = null) : BasicElement
      {
         ...
         for(var _loc20_ in param2.attributes)
         {
            switch(_loc20_)
            {
               ...
               case XmlAttributesEnum.ATTRIBUTE_IGNORE:
                  if(param2.attributes[_loc8_] == "1" || param2.attributes[_loc8_] == "true")
                  {
                     return null;
                  }
                  continue;
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            switch(_loc4_.nodeName)
            {
               ...
               case XmlTagsEnum.TAG_SIZE:
                  _loc9_ = this.parseSize(_loc4_,true);
                  if(_loc9_)
                  {
                     param3.size = _loc9_.toSizeElement();
                  }
                  break;
               ...
               case XmlTagsEnum.TAG_TREE:
                  switch(param2.nodeName)
                  {
                     ...
                     case XmlTagsEnum.TAG_TREE:
                     case XmlTagsEnum.TAG_GRID:
                        _loc13_ = this.parseGraphicElement(_loc4_);
                        if(_loc13_)
                        {
                           ContainerElement(param3).childs.push(_loc13_);
                        }
                        break;
                     default:
               ...
               case XmlTagsEnum.TAG_BUTTON:
                  switch(param2.nodeName)
                  {
                     ...
                     case XmlTagsEnum.TAG_INPUTCOMBOBOX:
                     case XmlTagsEnum.TAG_TREE:
                        if(_loc4_.attributes["ignore"] != "true")
                        {
               ...
               default:
                  ...
                  {
                     case XmlTagsEnum.TAG_CONTAINER:
                        _loc10_ = GraphicContainer;
                        break;
                     case XmlTagsEnum.TAG_BUTTON:
                        _loc10_ = ButtonContainer;
                        break;
                     case XmlTagsEnum.TAG_STATECONTAINER:
                        _loc10_ = StateContainer;
                        break;
                     case XmlTagsEnum.TAG_SCROLLCONTAINER:
                        _loc10_ = ScrollContainer;
                        break;
                     case XmlTagsEnum.TAG_GRID:
                        _loc10_ = Grid;
                        break;
                     case XmlTagsEnum.TAG_COMBOBOX:
                        ...
                        break;
                     case XmlTagsEnum.TAG_INPUTCOMBOBOX:
                        _loc10_ = InputComboBox;
                        break;
                     case XmlTagsEnum.TAG_TREE:
                        _loc10_ = Tree;
                  }
                  _loc12_ = this.getClassDesc(_loc10_);
                  if(_loc12_[_loc4_.nodeName])
                  {
                     if(_loc4_.firstChild)
                     {
                        _loc14_ = _loc4_.toString();
                        _loc15_ = _loc14_.substr(_loc4_.nodeName.length + 2,_loc14_.length - _loc4_.nodeName.length * 2 - 5);
                        _loc11_ = LangManager.getInstance().replaceKey(_loc15_);
                        switch(_loc12_[_loc4_.nodeName])
                        {
                           case "Boolean":
                              _loc11_ = _loc11_ != "false";
                              break;
                           case "*":
                              _loc11_ = _loc11_;
                              break;
                           default:
                              if(_loc11_.charAt(0) == "[" && _loc11_.charAt(_loc11_.length - 1) == "]")
                              {
                                 break;
                              }
                              _loc16_ = GameDataField.getClassByName(_loc12_[_loc4_.nodeName]);
                              _loc11_ = new _loc16_(_loc11_);
                              break;
                        }
                        ContainerElement(param3).properties[_loc4_.nodeName] = _loc11_;
                     }
                  }
                  else
                  {
                     switch(param2.nodeName)
                     {
                        ...
                        case XmlTagsEnum.TAG_TREE:
                           ...
                           else if(!_loc4_.nodeValue || StringUtil.trim(_loc4_.nodeValue).length > 0)
                           {
                        ...
                        default:
                           ...
                           {
                              _loc17_ = _loc4_.toString();
                              param3.properties[_loc4_.nodeName] = _loc17_.substr(_loc4_.nodeName.length + 2,_loc17_.length - _loc4_.nodeName.length * 2 - 5);
                           }
                     }
                  }
            }
      ...
      protected function parseSetProperties(param1:XMLNode, param2:Object) : void
      {
         ...
         var _loc5_:int = _loc4_.length;
         _loc6_ = 0;
         for(; _loc6_ < _loc5_; _loc6_ = _loc6_ + 1)
         {
            _loc3_ = _loc4_[_loc6_];
            if(_loc3_.nodeName == XmlTagsEnum.TAG_SETPROPERTY)
            {
               if(_loc3_.attributes[XmlAttributesEnum.ATTRIBUTE_IGNORE])
               {
                  if(_loc3_.attributes[XmlAttributesEnum.ATTRIBUTE_IGNORE] == "true")
                  {
                     continue;
                  }
               }
      ...
      private function cleanComponentProperty(param1:BasicElement, param2:Array = null) : Boolean
      {
         ...
         var _loc3_:Class = GameDataField.getClassByName(param1.className);
            ...
            if(_loc4_[_loc8_])
            {
               ...
               switch(_loc4_[_loc8_])
               {
                  ...
                  default:
                     ...
                     _loc7_ = GameDataField.getClassByName(_loc4_[_loc8_]);
      ...
      protected function parseSize(param1:XMLNode, param2:Boolean) : GraphicSize
      {
         ...
         var _loc8_:String = null;
         var _loc9_:String = null;
         if(param1.attributes.length > 0 || param1.attributes["ignore"])
         {
            if(param1.attributes["ignore"])
            {
               if(param1.attributes["ignore"] == "true")
               {
                  return null;
               }
            }
            ...
            {
               this._log.warn("[" + this._sUrl + "]" + param1.nodeName + " cannot have attribut except ignore");
            }
         }
         var _loc4_:Array = param1.childNodes;
         var _loc5_:int = _loc4_.length;
      ...
      protected function parseAnchors(param1:XMLNode) : Array
      {
         ...
         {
            this._log.warn("[" + this._sUrl + "]" + param1.nodeName + " cannot have attributes");
         }
         var _loc3_:Array = param1.childNodes;
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            {
               for(var _loc14_ in _loc2_.attributes)
               {
                  switch(_loc14_)
                  {
                     case XmlAttributesEnum.ATTRIBUTE_POINT:
                        ...
                        {
                           this._glPoint.setPoint(_loc2_.attributes[_loc9_]);
                        }
                        continue;
                     case XmlAttributesEnum.ATTRIBUTE_RELATIVEPOINT:
                        this._glPoint.setRelativePoint(_loc2_.attributes[_loc9_]);
                        continue;
                     case XmlAttributesEnum.ATTRIBUTE_RELATIVETO:
                        this._glPoint.setRelativeTo(_loc2_.attributes[_loc9_]);
                        continue;
                     default:
                        this._log.warn("[" + this._sUrl + "]" + param1.nodeName + " cannot have attribute " + _loc9_);
                        continue;
                  }
               }
               _loc10_ = _loc2_.childNodes;
               _loc11_ = _loc10_.length;
               _loc6_ = 0;
               while(_loc6_ < _loc11_)
               {
                  _loc7_ = _loc10_[_loc6_];
               ...
               _loc8_.push(this._glPoint.toLocationElement());
            }
            else
            {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            switch(_loc2_.nodeName)
            {
               ...
               case EventEnums.EVENT_ONMAPROLLOUT:
                  _loc6_ = EventEnums.EVENT_ONMAPROLLOUT_MSG;
                  break;
