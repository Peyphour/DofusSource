package com.ankamagames.berilia.components
{
   ...
   public class Grid extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      public function set hPadding(param1:int) : void
      {
         this._hPadding = param1;
         if(finalized)
         {
            this.finalize();
         }
      ...
      public function set vPadding(param1:int) : void
      {
         this._vPadding = param1;
         if(finalized)
         {
            this.finalize();
         }
      ...
      public function set allowLastToFirst(param1:Boolean) : void
      {
         this._allowLastToFirst = param1;
      }
      ...
      public function set useLeftRightToSelect(param1:Boolean) : void
      {
         this._useLeftRightToSelect = param1;
      }
      ...
      public function set scrollbarOffset(param1:int) : void
      {
         this._scrollbarOffset = param1;
      }
      ...
      public function removeItems() : void
      {
         ...
         if(this._renderer)
         {
            ...
            {
               this._renderer.remove(this._items[_loc1_].container);
               _loc1_++;
            }
      ...
      {
         var _loc2_:GridItem = this.getGridItem(param1);
         if(_loc2_)
         {
            return _loc2_.index;
         }
      ...
      private function itemExists(param1:*) : Boolean
      {
         ...
         if(this._dataProvider)
         {
            ...
            while(_loc2_ < _loc3_)
            {
               _loc4_ = this._dataProvider[_loc2_];
               if(_loc4_ === param1)
               {
                  return true;
               }
      ...
      function setSelectedIndex(param1:int, param2:uint) : void
      {
         ...
         if(this._allowLastToFirst)
         {
            ...
            if(param1 < 0)
            {
               param1 = this._dataProvider.length - 1;
            }
         }
      ...
      private function configVar() : void
      {
         ...
         while(_loc1_ < 2)
         {
            ...
            this._avaibleSpaceX = width - (this._verticalScroll && _loc2_?this._scrollBarSize + this._scrollbarOffset:0);
            this._avaibleSpaceY = height - (!this._verticalScroll && _loc2_?this._scrollBarSize + this._scrollbarOffset:0);
