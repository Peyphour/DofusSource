package com.ankamagames.berilia.components
{
   ...
   public class EntityDisplayer extends GraphicContainer implements UIComponent, IRectangle
   {
      ...
      {
         this._entity.height = param1 / (this._realWidth / this._realHeight) * this.entityScale;
         this._entity.width = param1 * this.entityScale;
      }
      
      public function set fixedHeight(param1:Number) : void
      {
         this._entity.height = param1 * this.entityScale;
         this._entity.width = param1 / (this._realHeight / this._realWidth) * this.entityScale;
      }
      ...
      public function updateMask() : void
      {
         ...
         {
            _loc1_ = !!this.maskRect?this.maskRect.split(","):null;
            _loc2_ = !!_loc1_?Number(_loc1_[0]):Number(0);
            _loc3_ = !!_loc1_?Number(_loc1_[1]):Number(0);
            _loc4_ = !!_loc1_?Number(_loc1_[2]):Number(width);
            _loc5_ = !!_loc1_?Number(_loc1_[3]):Number(height);
            if(this._mask)
            {
            ...
            this._mask.graphics.drawRect(_loc2_,_loc3_,_loc4_,_loc5_);
            addChild(this._mask);
      ...
      public function updateScaleAndOffsets() : void
      {
         ...
         if(this._view != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               _loc5_ = width / height < _loc3_.width / _loc3_.height?Number(width / _loc3_.getRect(this).width):Number(height / _loc3_.getRect(this).height);
