   ...
   public class ScrollBar extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      private function scrollBarInit() : void
      {
         ...
         if(!this._gcBox)
         {
            ...
            {
               _loc1_[StatesEnum.STATE_OVER][this._texBox.name]["themeDataId"] = this._texBox.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_OVER_STRING.toLocaleLowerCase();
            }
            ...
            {
               _loc1_[StatesEnum.STATE_CLICKED][this._texBox.name]["themeDataId"] = this._texBox.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_CLICKED_STRING.toLocaleLowerCase();
            }
            ...
            if(this._texMin)
            {
               ...
               {
                  _loc1_[StatesEnum.STATE_OVER][this._texMin.name]["themeDataId"] = this._texMin.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_OVER_STRING.toLocaleLowerCase();
               }
               ...
               {
                  _loc1_[StatesEnum.STATE_CLICKED][this._texMin.name]["themeDataId"] = this._texMin.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_CLICKED_STRING.toLocaleLowerCase();
               }
            ...
            if(this._texMax)
            {
               ...
               {
                  _loc1_[StatesEnum.STATE_CLICKED][this._texMax.name]["themeDataId"] = this._texMax.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_OVER_STRING.toLocaleLowerCase();
               }
               ...
               {
                  _loc1_[StatesEnum.STATE_CLICKED][this._texMax.name]["themeDataId"] = this._texMax.themeDataId.replace("_normal","") + "_" + StatesEnum.STATE_CLICKED_STRING.toLocaleLowerCase();
               }
      ...
      private function scrollBarProcess() : void
      {
         ...
         var _loc2_:uint = this._squareEdge;
         if(!this._texMin && !this._texMax)
         {
            _loc2_ = 0;
         }
         if(!this._texBack.stage || !this._texBack.finalized)
         {
            ...
            this._texBack.height = this._nHeight - _loc2_ * 0.4;
            this._texBack.x = 0;
            this._texBack.y = 0;
         ...
         if(this._texMin)
         {
            if(!this._texMin.finalized)
            {
               if(this._bVertical)
               {
                  this._texMin.width = _loc2_;
               }
               else
               {
                  this._texMin.height = _loc2_;
               }
               if(this._texMin is Texture)
               {
         ...
         if(this._texMax)
         {
            if(!this._texMax.finalized)
            {
               if(this._bVertical)
               {
                  this._texMax.width = _loc2_;
               }
               else
               {
                  this._texMax.height = _loc2_;
               }
               if(this._texMax is Texture)
               {
               ...
               this._gcMax.x = !!this._bVertical?Number(0):Number(this._nWidth - _loc2_);
               this._gcMax.y = !!this._bVertical?Number(this._nHeight - _loc2_):Number(0);
         ...
         this._nBoxSize = (_loc1_ - 2 * _loc2_) * ((this._nTotal - this._nMax) / this._nTotal);
         this._nBoxSize = Math.max(this._squareEdge,this._nBoxSize);
         var _loc3_:int = 0;
         if(this._texMin)
         {
            _loc3_ = 6;
            this._nBoxPosMin = _loc2_ - _loc3_;
         }
         else
         {
            this._nBoxPosMin = 0;
         }
         this._nBoxPosMax = Math.ceil(_loc1_ - _loc2_ - this._nBoxSize);
         this._nScrollStep = (_loc1_ - 2 * _loc2_ + _loc3_ - this._nBoxSize) / (this._nMax - this._nMin);
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         var _loc2_:int = this._nCurrentPos;
      ...
      private function onTopArrowDown(param1:Event) : void
      {
         ...
         var _loc3_:Number = this._nCurrentPos;
      ...
      private function onCssLoaded() : void
      {
         ...
         if(!this._gcBox)
         {
            ...
            this._texBack = this.initTexture("Back",_loc2_);
            this._texBox = this.initTexture("Box",_loc2_);
            this._texMax = this.initTexture("Max",_loc2_);
            this._texMin = this.initTexture("Min",_loc2_);
         }
         this.scrollBarInit();
      }
      ...
      {
         if(param1.target == this._texMin && this._texMin is Texture)
         {
         ...
         else if(param1.target == this._texMax && this._texMax is Texture)
         {
