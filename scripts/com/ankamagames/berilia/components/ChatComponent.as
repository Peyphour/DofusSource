package com.ankamagames.berilia.components
{
   ...
   public class ChatComponent extends GraphicContainer implements UIComponent, IRectangle, FinalizableUIComponent
   {
      ...
      private var _smilies:Vector.<Smiley#3081>;
      ...
      public function initSmileyTab(param1:String, param2:Object) : void
      {
         ...
         this._smilies = new Vector.<Smiley#3081>();
         for each(_loc3_ in param2)
         {
            if(_loc3_.triggers != null && _loc3_.triggers.length > 0)
            {
               _loc4_ = new Smiley#3081(_loc3_.gfxId);
      ...
      private function createSpan(param1:ParagraphElement, param2:String, param3:Boolean, param4:String = "") : void
      {
         ...
         while(param2.length > 0)
         {
            ...
            _loc7_ = param2.substring(0,_loc6_ != null?Number(_loc6_.position):Number(param2.length));
      ...
      private function getSmileyFromText(param1:String) : Smiley#3081
      {
         var _loc2_:int = 0;
...
class Smiley#3081
{
   ...
   function Smiley#3081(param1:String)
   {
      super();
      this.pictoId = param1;
      this.position = -1;
