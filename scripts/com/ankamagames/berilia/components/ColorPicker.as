package com.ankamagames.berilia.components
{
   ...
   public class ColorPicker extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      public function getGradientColor() : uint
      {
         ...
         if(_loc3_ != _loc6_)
         {
            _loc11_ = Math.round(_loc3_ > _loc6_?Number(255 - _loc2_):Number(_loc2_));
         }
         else
         {
            _loc11_ = _loc3_ >> 16;
         ...
         if(_loc4_ != _loc7_)
         {
            _loc12_ = Math.round(_loc4_ > _loc7_?Number(255 - _loc2_):Number(_loc2_));
         }
         else
         {
            _loc12_ = _loc4_ >> 8;
         ...
         if(_loc5_ != _loc8_)
         {
            _loc13_ = Math.round(_loc5_ > _loc8_?Number(255 - _loc2_):Number(_loc2_));
         }
         else
         {
            _loc13_ = _loc5_;
