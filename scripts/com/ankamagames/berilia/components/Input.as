package com.ankamagames.berilia.components
{
   ...
   public class Input extends Label implements UIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#2861>;
      ...
      public function Input()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#2861>(0);
      ...
      private function addHistory(param1:String) : void
      {
         ...
         var _loc3_:InputEntry = new InputEntry#2861(param1,_loc2_);
      ...
      override public function process(param1:Message) : Boolean
      {
         ...
         if(param1 is MouseWheelMessage && !disabled && _loc2_.toString(10) == text.split(" ").join("").split(" ").join("").split(this._numberSeparator).join(""))
         {
            ...
            _loc4_ = Math.abs(_loc2_) > 99?int(Math.pow(10,(_loc2_ + _loc3_).toString(10).length - 2)):1;
...
class InputEntry#2861
{
   ...
   function InputEntry#2861(param1:String, param2:Vector.<String>)
   {
      super();
      this._text = param1;
