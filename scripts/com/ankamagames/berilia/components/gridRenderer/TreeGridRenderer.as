      ...
      public function TreeGridRenderer(param1:String)
      {
         ...
         if(param1)
         {
            ...
            if(_loc2_[1] && _loc2_[1].length)
            {
               ...
               {
                  this._bgColor1.alphaMultiplier = ((parseInt(_loc2_[1],16) & 4278190080) >> 24) / 255;
               }
            }
            if(_loc2_[2] && _loc2_[2].length)
            {
               ...
               {
                  this._bgColor2.alphaMultiplier = ((parseInt(_loc2_[2],16) & 4278190080) >> 24) / 255;
               }
            }
            if(_loc2_[3] && _loc2_[3].length)
            {
               ...
               {
                  this._overColor.alphaMultiplier = ((parseInt(_loc2_[3],16) & 4278190080) >> 24) / 255;
               }
            }
            if(_loc2_[4] && _loc2_[4].length)
            {
               ...
               {
                  this._selectedColor.alphaMultiplier = ((parseInt(_loc2_[4],16) & 4278190080) >> 24) / 255;
               }
            }
