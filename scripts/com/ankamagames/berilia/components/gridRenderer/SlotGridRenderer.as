package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class SlotGridRenderer implements IGridRenderer, ICustomSecureObject
   {
      ...
      public function SlotGridRenderer(param1:String)
      {
         ...
         this._activeFunctionName = _loc2_[10] && _loc2_[10].length?_loc2_[10]:null;
         this._backgroundTexture = _loc2_[11] && _loc2_[11].length?new Uri(_loc2_[11]):null;
      }
      ...
      public function render(param1:*, param2:uint, param3:Boolean, param4:uint = 0) : DisplayObject
      {
         ...
         _loc6_.forcedBackGroundIconUri = this._backgroundTexture;
         ...
         _loc6_.isActiveFunction = !!this._activeFunctionName?this._grid.getUi().uiClass[this._activeFunctionName]:null;
      ...
      public function update(param1:*, param2:uint, param3:DisplayObject, param4:Boolean, param5:uint = 0) : void
      {
         ...
         {
            _loc6_ = Slot(param3);
            _loc6_.data = param1 as ISlotData;
            if(!this._isButton)
            {
