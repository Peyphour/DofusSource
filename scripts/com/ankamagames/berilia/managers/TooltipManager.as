   ...
   public class TooltipManager
   {
         ...
         if(param13)
         {
            ...
            if(_tooltipCache[_loc19_[0]] && _loc19_.length == 1 || _tooltipCache[_loc19_[0]] && _loc19_.length > 1 && _tooltipCacheParam[_loc19_[0]] == _loc19_[1])
            {
               ...
               if(_loc20_ != null && _loc20_.display != null && _loc20_.display.uiClass != null)
               {
                  ...
                  _loc20_.display.uiClass.main(new TooltipProperties(_loc20_,param4,getTargetRect(param2),param6,param7,param8,param1,param12,param16,param17,param2));
               }
               return _loc20_;
            }
         }
      ...
      public static function hide(param1:String = "standard") : void
      {
         ...
         if(_tooltips[param1])
         {
            ...
            if(param1 == TOOLTIP_UI_NAME_PREFIX + TOOLTIP_STANDAR_NAME)
            {
               _loc2_ = Berilia.getInstance().strataTooltip.getChildByName(param1);
               if(_loc2_ && _loc2_.parent && !Berilia.getInstance().getUi(param1))
               {
      ...
      public static function hasCache(param1:String) : Boolean
      {
         var _loc2_:Tooltip = _tooltipCache[param1.split("#")[0]] as Tooltip;
         return _loc2_ != null && _loc2_.display != null && _loc2_.display.uiClass != null;
      }
      ...
      public static function update(param1:String, param2:Array) : void
      {
         var _loc3_:Tooltip = _tooltipCache[param1] as Tooltip;
         if(_loc3_)
         {
            _loc3_.display.uiClass.update(param2);
         }
      }
      
      public static function updatePosition(param1:String, param2:String, param3:*, param4:uint, param5:uint, param6:int, param7:Boolean = true, param8:Boolean = false, param9:int = -1, param10:IRectangle = null) : void
      {
         var _loc11_:Tooltip = null;
         var _loc12_:TooltipRectangle = null;
         if(isVisible(param2))
         {
            _loc11_ = _tooltipCache[param1] as Tooltip;
            if(_loc11_)
            {
               _loc11_.display.x = 0;
               _loc11_.display.y = 0;
               _loc12_ = getTargetRect(param3);
               TooltipPlacer.place(_loc11_.display,_loc12_,param4,param5,param6,param7);
               if(param8 && param9 != -1)
               {
                  TooltipPlacer.addTooltipPosition(_loc11_.display,_loc12_,param9,param10);
               }
            }
         }
      }
      ...
      private static function onTooltipReady(param1:Tooltip, param2:UiModule, param3:String, param4:*, param5:*, param6:Boolean, param7:uint, param8:uint, param9:int, param10:String, param11:int, param12:Object, param13:Number, param14:Boolean) : void
      {
         ...
         _log.info(param3 + " xml generated in " + (getTimer() - showStartTime) + "ms");
         ...
         if(_loc16_ || param10)
         {
            ...
            param1.display = Berilia.getInstance().loadUi(param2,_loc17_,param3,new TooltipProperties(param1,param6,getTargetRect(param5),param7,param8,param9,param4,param12,param13,param14),true,param11,!_loc16_,null);
            if(param10)
            {
      ...
      public static function getTargetRect(param1:*) : TooltipRectangle
      {
         ...
         if(_loc3_)
         {
            ...
            _loc7_ = _loc3_ is DisplayObject?Boolean(Berilia.getInstance().docMain.contains(_loc3_)):false;
