package com.ankamagames.berilia.managers
{
   ...
   public class UiRenderManager extends EventDispatcher
   {
      ...
      public function loadUi(param1:UiData, param2:UiRootContainer, param3:* = null, param4:Boolean = true) : void
      {
         ...
         {
            if(param1.module is PreCompiledUiModule && param4)
            {
      ...
      private function onUiRender(param1:UiRenderEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = getTimer() - this._lastRenderStart;
            _log.info(_loc2_.name + " rendered in " + _loc3_ + " ms " + "(parsing: " + param1.uiRenderer.parsingTime + " ms, build: " + param1.uiRenderer.buildTime + " ms, script:" + param1.uiRenderer.scriptTime + " ms )");
            UiPerformanceManager.getInstance().saveUiLoadStats(_loc2_.name,{
               "renderTime":_loc3_,
               "parsingTime":param1.uiRenderer.parsingTime,
               "buildTime":param1.uiRenderer.buildTime,
               "scriptTime":param1.uiRenderer.scriptTime
            });
         }
