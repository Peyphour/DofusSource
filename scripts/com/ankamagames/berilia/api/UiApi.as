   ...
   public class UiApi implements IApi
   {
      ...
      public function loadUi(param1:String, param2:String = null, param3:* = null, param4:uint = 1, param5:String = null, param6:Boolean = false, param7:Boolean = false, param8:Boolean = true) : Object
      {
         ...
         if(!this._module.uis[param1])
         {
            if(param1.indexOf("::") != -1)
            {
               ...
               _loc9_ = UiModuleManager.getInstance().getModule(_loc11_[0]);
               if(!_loc9_)
               {
                  throw new BeriliaError("Module [" + _loc11_[0] + "] does not exist");
               }
         ...
         {
            _loc12_ = Berilia.getInstance().loadUi(_loc9_,_loc9_.uis[_loc10_],param2,param3,param6,param4,false,param5,param7,param8);
            if(_loc10_ != "tips" && _loc10_ != "buffUi")
            {
               FocusHandler.getInstance().setFocus(_loc12_);
            }
            return _loc12_;
         }
         return null;
      ...
      public function loadUiInside(param1:String, param2:GraphicContainer, param3:String = null, param4:* = null) : Object
      {
         ...
         if(_loc5_.uis[_loc6_])
         {
            ...
            _loc8_.restoreSnapshotAfterLoading = param2.getUi().restoreSnapshotAfterLoading;
      ...
      {
         if(param1.getChildByName(param2.name))
         {
      ...
      {
         Berilia.getInstance().resetUiSavedUserModification(param1);
      }
      ...
      public function clearPositionCache(param1:String = null) : void
      {
         ...
         {
            StoreDataManager.getInstance().setData(BeriliaConstants.DATASTORE_UI_POSITIONS,param1,null);
         }
      }
      
      [NoBoxing]
      [Untrusted]
      public function createUri(param1:String, param2:Boolean = false) : Uri
      {
         if(!this._assetUris[param1] || param2)
         {
            if(param1 && param1.indexOf(":") == -1 && param1.indexOf("./") != 0 && param1.indexOf("\\\\") != 0 && param1.indexOf("//") != 0)
            {
               param1 = "mod://" + this._module.id + "/" + param1;
            }
            this._assetUris[param1] = new Uri(param1);
      ...
      public function showTooltip(param1:*, param2:*, param3:Boolean = false, param4:String = "standard", param5:uint = 0, param6:uint = 2, param7:int = 3, param8:String = null, param9:Class = null, param10:Object = null, param11:String = null, param12:Boolean = false, param13:int = 4, param14:Number = 1, param15:String = "") : void
      {
         ...
         if((!param10 || !param10.hasOwnProperty("pinnable") || !param10.pinnable) && HumanInputHandler.getInstance().isMouseDown)
         {
            return;
         }
         if(param15 || this._currentUi)
         {
            ...
            if(_loc16_)
            {
               if(param15)
               {
                  _loc16_.uiModuleName = param15;
               }
               else if(this._currentUi)
               {
                  _loc16_.uiModuleName = this._currentUi.name;
               }
            }
         }
      }
      ...
      public function endDrag() : void
      {
         ...
         if(_loc1_ && _loc1_.data is SlotDragAndDropData)
         {
            ...
            KernelEventsManager.getInstance().processCallback(BeriliaHookList.DropEnd,SlotDragAndDropData(_loc1_.data).currentHolder);
         }
      }
      ...
      {
         var _loc3_:StyleSheet = CssManager.getInstance().getCss(param2);
         if(_loc3_)
         {
            param1.setStyleSheet(_loc3_);
         }
         else
         {
            _log.error(param2 + " is not loaded yet!");
         }
      }
      ...
      public function place(param1:*, param2:uint, param3:uint, param4:int, param5:GraphicContainer = null) : void
      {
         if(!param1)
         {
            param1 = new Rectangle2(StageShareManager.mouseX,StageShareManager.mouseY,0,0);
         }
         if(!param5)
         {
            param5 = this._currentUi;
         }
         TooltipPlacer.place(param5,param1,param3,param2,param4);
      }
      ...
      {
         return Berilia.getInstance().loadingUi[param1];
      }
      
      [Untrusted]
      public function getColor(param1:String) : Color
      {
         return param1.length == 10?new ARGBColor(parseInt(param1,16)):new Color(parseInt(param1,16));
      }
