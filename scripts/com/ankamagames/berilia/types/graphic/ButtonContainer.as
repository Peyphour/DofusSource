package com.ankamagames.berilia.types.graphic
{
   ...
   public class ButtonContainer extends StateContainer implements IRadioItem, FinalizableUIComponent, IDragAndDropHandler
   {
      ...
      public function set tooltipContent(param1:String) : void
      {
         this._tooltipContent = param1;
      }
         ...
         if(!this._disabled)
         {
            switch(true)
            {
               case param1 is MouseDownMessage:
                  ...
                  _loc2_ = !!this._selected?uint(StatesEnum.STATE_SELECTED_CLICKED):uint(StatesEnum.STATE_CLICKED);
                  break;
               ...
               case param1 is MouseClickMessage:
                  ...
                  _loc2_ = !!this._selected?uint(StatesEnum.STATE_SELECTED_OVER):uint(StatesEnum.STATE_OVER);
                  if(!changingStateData[_loc2_])
                  {
                     _loc2_ = !!this._selected?uint(StatesEnum.STATE_SELECTED):uint(StatesEnum.STATE_NORMAL);
                  }
                  if(!this.isMute)
                  {
