package com.ankamagames.berilia.types.shortcut
{
   ...
   public class Shortcut implements IDataCenter
   {
      ...
      public function Shortcut(param1:String, param2:Boolean = false, param3:String = null, param4:ShortcutCategory = null, param5:Boolean = true, param6:Boolean = true, param7:Boolean = false, param8:Boolean = false, param9:String = null, param10:Boolean = false)
      {
         super();
