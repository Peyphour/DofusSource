   ...
   public class RasterizedFrame
   {
      ...
      public function RasterizedFrame(param1:MovieClip, param2:int)
      {
         ...
         if(_loc3_.width + _loc3_.height)
         {
            ...
            _loc8_ = _loc6_ > 0?Number(_loc3_.width * _loc6_):Number(-_loc3_.width * _loc6_);
            _loc9_ = _loc7_ > 0?Number(_loc3_.height * _loc7_):Number(-_loc3_.height * _loc7_);
            _loc10_ = _loc6_ > 0?Number(_loc3_.x * _loc6_):Number((_loc3_.x + _loc3_.width) * _loc6_);
            _loc11_ = _loc7_ > 0?Number(_loc3_.y * _loc7_):Number((_loc3_.y + _loc3_.height) * _loc7_);
