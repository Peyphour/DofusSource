package com.ankamagames.atouin.managers
{
   ...
   public class MapDisplayManager
   {
      ...
      public function display(param1:WorldPoint, param2:Boolean = false, param3:ByteArray = null, param4:Boolean = true, param5:Boolean = true) : uint
      {
         var _loc6_:RenderRequest = new RenderRequest(param1,param2,param3,param4,param5);
         _log.debug("Ask render map " + param1.mapId + ", renderRequestID: " + _loc6_.renderId);
         this._renderRequestStack.push(_loc6_);
         this.checkForRender(param5);
         return _loc6_.renderId;
      }
      ...
      private function checkForRender(param1:Boolean = true) : void
      {
         var _loc6_:Map = null;
         var _loc7_:MapsLoadingCompleteMessage = null;
         var _loc8_:Atouin = null;
         ...
         var _loc2_:RenderRequest = RenderRequest(this._renderRequestStack[0]);
         var _loc3_:WorldPoint = _loc2_.map;
         var _loc4_:Boolean = _loc2_.forceReloadWithoutCache;
         Atouin.getInstance().showWorld(param1);
         this._renderer.initRenderContainer(Atouin.getInstance().worldContainer);
         if(!_loc4_ && this._currentMap && this._currentMap.mapId == _loc3_.mapId && !Atouin.getInstance().options.reloadLoadedMap)
         {
            this._renderRequestStack.shift();
            _log.debug("Map " + _loc3_.mapId + " is the same, renderRequestID: " + _loc2_.renderId);
            _loc6_ = MapDisplayManager.getInstance().getDataMapContainer().dataMap;
            _loc7_ = new MapsLoadingCompleteMessage(this._currentMap,_loc6_);
            _loc8_ = Atouin.getInstance();
            _loc8_.handler.process(_loc7_);
            _loc7_.renderRequestId = _loc2_.renderId;
            _loc8_.applyMapZoomScale(_loc6_);
            this.checkForRender();
            return;
         }
         this._currentMapRendered = false;
         this._lastMap = this._currentMap;
         this._currentMap = _loc3_;
         this._currentRenderId = _loc2_.renderId;
         this._forceReloadWithoutCache = _loc4_;
         var _loc5_:MapsLoadingStartedMessage = new MapsLoadingStartedMessage();
         _loc5_.id = this._currentMap.mapId;
         Atouin.getInstance().handler.process(_loc5_);
         this._nMapLoadStart = getTimer();
         this._loader.cancel();
         this._loader.load(new Uri(getMapUriFromId(_loc3_.mapId)),null);
      }
...
class RenderRequest
{
   ...
   function RenderRequest(param1:WorldPoint, param2:Boolean, param3:ByteArray, param4:Boolean = true, param5:Boolean = true)
   {
      super();
