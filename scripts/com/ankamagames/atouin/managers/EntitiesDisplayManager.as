package com.ankamagames.atouin.managers
{
   ...
   public class EntitiesDisplayManager
   {
      ...
      public function displayEntity(param1:IDisplayable, param2:MapPoint, param3:uint = 0, param4:Boolean = true, param5:Function = null) : void
      {
         var displayObject:DisplayObject = null;
         var oEntity:IDisplayable = param1;
         var cellCoords:MapPoint = param2;
         var strata:uint = param3;
         var useStrataCache:Boolean = param4;
         var customOrderFunction:Function = param5;
         try
         {
      ...
      public function orderEntity(param1:DisplayObject, param2:Sprite) : void
      {
         ...
         if(Atouin.getInstance().options.transparentOverlayMode && param1 is ITransparency && ITransparency(param1).getIsTransparencyAllowed())
         {
            ...
            _loc9_ = Atouin.getInstance().overlayContainer;
            _loc10_ = _loc9_.numChildren;
            var _loc8_:uint = 0;
            while(_loc8_ < _loc10_)
            {
               _loc7_ = _loc9_.getChildAt(_loc8_);
            ...
            if(_loc9_.contains(param1) && _loc8_ > 0)
            {
               _loc9_.addChildAt(param1,_loc8_ - 1);
            }
            else
            {
               _loc9_.addChildAt(param1,_loc8_);
            }
            return;
         }
         ...
         while(_loc8_ < _loc6_)
         {
            _loc7_ = param2.parent.getChildAt(_loc8_);
