package com.ankamagames.atouin.renderers
{
   ...
   public class ZoneClipRenderer implements IFightZoneRenderer
   {
      ...
      public function ZoneClipRenderer(param1:uint, param2:String, param3:Array, param4:int = -1, param5:Boolean = false, param6:Boolean = true)
      {
         super();
         this._aZoneTile = new Array();
         this._aCellTile = new Array();
         this.currentStrata = param1;
         this._currentMapId = param4;
         this._needBorders = param5;
         this._useStrataOrderHack = param6;
      ...
      public function get clipName() : Array
      {
         return this._clipName;
      }
      
      public function set clipName(param1:Array) : void
      {
         this._clipName = param1;
      }
      ...
      public function render(param1:Vector.<uint>, param2:Color, param3:DataMapContainer, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(this._currentMapId > -1)
         {
            ...
            while(_loc6_ < _loc8_)
            {
               if(!(!this.showFarmCell && param3.dataMap.cells[param1[_loc6_]].farmCell))
               {
                  ...
                  _loc7_.useStrataOrderHack = this._useStrataOrderHack;
                  _loc7_.display();
               }
               _loc6_++;
            }
