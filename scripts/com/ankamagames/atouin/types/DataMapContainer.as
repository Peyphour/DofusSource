package com.ankamagames.atouin.types
{
   ...
   public class DataMapContainer
   {
      ...
      public function addAlwayAnimatedElement(param1:int) : void
      {
         var _loc2_:Object = null;
         for each(_loc2_ in this._animatedElement)
         {
            if(_loc2_.element.identifier == param1)
            {
               this._alwaysAnimatedElement[_loc2_] = true;
               this.updateAnimatedElement(_loc2_);
            }
         }
      }
      
      public function removeAlwayAnimatedElement(param1:int) : void
      {
         var _loc2_:Object = null;
         for each(_loc2_ in this._animatedElement)
         {
            if(_loc2_.element.identifier == param1)
            {
               delete this._alwaysAnimatedElement[_loc2_];
               this.updateAnimatedElement(_loc2_);
            }
         }
      }
      ...
      private function updateAnimatedElement(param1:Object) : void
      {
         ...
         var _loc4_:Boolean = this._temporaryEnable && (this._allowAnimatedGfx || this._alwaysAnimatedElement[param1]);
