package com.ankamagames.dofus.scripts.spells
{
   ...
   public class SpellScript3 extends SpellScriptBase
   {
      ...
      public function SpellScript3(param1:SpellFxRunner)
      {
         ...
         {
            addNewGfxEntityStep(_loc3_,_loc3_,_loc2_,PREFIX_CASTER,"",caster);
         }
         if(SpellFxApi.HasSpellParam(spell,"trailGfxId") && _loc5_)
         {
            ...
            _loc12_ = SequenceApi.CreateAddGfxInLineStep(runner,SpellFxApi.GetSpellParam(spell,"trailGfxId"),_loc3_,_loc5_,SpellFxApi.GetSpellParam(spell,"trailGfxYOffset"),SpellFxApi.GetSpellParam(spell,"trailDisplayType"),SpellFxApi.GetSpellParam(spell,"trailGfxMinScale"),SpellFxApi.GetSpellParam(spell,"trailGfxMaxScale"),SpellFxApi.GetSpellParam(spell,"startTrailOnCaster"),SpellFxApi.GetSpellParam(spell,"endTrailOnTarget"),_loc9_,_loc10_,_loc11_,caster);
         ...
         {
            addNewGfxEntityStep(_loc2_,_loc6_,_loc2_,PREFIX_TARGET);
         }
         addAnimHitSteps();
         destroy();
      }
