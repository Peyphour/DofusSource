   ...
   public class SpellScript6 extends SpellScriptBase
   {
      ...
      public function SpellScript6(param1:SpellFxRunner)
      {
         ...
         if(SpellFxApi.HasSpellParam(spell,"casterGfxId"))
         {
            ...
            _loc9_ = SequenceApi.CreateAddGfxEntityStep(runner,SpellFxApi.GetSpellParam(spell,"casterGfxId"),FxApi.GetEntityCell(caster),_loc6_,_loc7_,SpellFxApi.GetSpellParam(spell,"casterGfxDisplayType"),FxApi.GetEntityCell(caster),FxApi.GetCurrentTargetedCell(runner),_loc8_,caster);
            if(!latestStep)
            {
         ...
         if(SpellFxApi.HasSpellParam(spell,"targetGfxId"))
         {
            ...
            _loc13_ = SequenceApi.CreateAddGfxEntityStep(runner,SpellFxApi.GetSpellParam(spell,"targetGfxId"),_loc2_,_loc10_,_loc11_,SpellFxApi.GetSpellParam(spell,"targetGfxDisplayType"),FxApi.GetEntityCell(caster),FxApi.GetCurrentTargetedCell(runner),_loc12_,caster);
            if(!latestStep)
            {
