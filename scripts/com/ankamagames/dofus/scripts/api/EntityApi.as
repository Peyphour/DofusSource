package com.ankamagames.dofus.scripts.api
{
   ...
   public class EntityApi implements LuaPackage
   {
      ...
      public function getEntity(param1:Number) : ScriptEntity
      {
      ...
      public function getWorldEntity(param1:Number) : ScriptEntity
      {
      ...
      public function createMonster(param1:Number, param2:Boolean = true, param3:int = 0, param4:int = 0, param5:int = 1) : ScriptEntity
      {
      ...
      {
         var _loc2_:Number = EntitiesManager.getInstance().getFreeEntityId();
