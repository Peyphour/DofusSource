package com.ankamagames.dofus.internalDatacenter.communication
{
   ...
   public class ChatSentenceWithSource extends BasicChatSentence implements IDataCenter
   {
      ...
      public function ChatSentenceWithSource(param1:uint, param2:String, param3:String, param4:uint = 0, param5:Number = 0, param6:String = "", param7:Number = 0, param8:String = "", param9:Vector.<ItemWrapper> = null, param10:Boolean = false)
      {
