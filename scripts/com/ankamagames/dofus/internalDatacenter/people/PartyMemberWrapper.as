package com.ankamagames.dofus.internalDatacenter.people
{
   ...
   public class PartyMemberWrapper implements IDataCenter
   {
      ...
      public function PartyMemberWrapper(param1:Number, param2:String, param3:uint, param4:Boolean, param5:Boolean = false, param6:int = 0, param7:EntityLook = null, param8:int = 0, param9:int = 0, param10:int = 0, param11:int = 0, param12:int = 0, param13:int = 0, param14:int = 0, param15:int = 0, param16:int = 0, param17:int = 0, param18:int = 0, param19:int = 0, param20:Array = null)
      {
