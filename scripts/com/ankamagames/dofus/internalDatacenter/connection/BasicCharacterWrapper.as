package com.ankamagames.dofus.internalDatacenter.connection
{
   ...
   public class BasicCharacterWrapper implements IDataCenter
   {
      ...
      public static function create(param1:Number, param2:String, param3:uint, param4:EntityLook, param5:uint, param6:Boolean, param7:uint = 0, param8:uint = 0, param9:uint = 0, param10:Boolean = false) : BasicCharacterWrapper
      {
