package com.ankamagames.dofus.internalDatacenter.guild
{
   ...
   public class GuildWrapper implements IDataCenter
   {
      ...
      public static function create(param1:uint, param2:String, param3:GuildEmblem, param4:Number) : GuildWrapper
      {
         ...
         _loc5_ = new GuildWrapper();
         _loc5_.initDictionary();
         _loc5_.guildId = param1;
         _loc5_._guildName = param2;
         _loc5_._memberRightsNumber = param4;
         if(param3 != null)
         {
            _loc5_.upEmblem = EmblemWrapper.create(param3.symbolShape,EmblemWrapper.UP,param3.symbolColor);
            _loc5_.backEmblem = EmblemWrapper.create(param3.backgroundShape,EmblemWrapper.BACK,param3.backgroundColor);
         }
         return _loc5_;
      }
      ...
      {
         var _loc1_:GuildWrapper = create(this.guildId,this.guildName,null,this.memberRightsNumber);
