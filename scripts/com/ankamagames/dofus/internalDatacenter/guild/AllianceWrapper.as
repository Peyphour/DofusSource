   ...
   public class AllianceWrapper implements IDataCenter
   {
      ...
      private static function getFromBasicAllianceInformations(param1:BasicAllianceInformations) : AllianceWrapper
      {
         ...
         if(param1 is AllianceInformations)
         {
            ...
            _loc2_.upEmblem = EmblemWrapper.fromNetwork(_loc3_,false,true);
            _loc2_.backEmblem = EmblemWrapper.fromNetwork(_loc3_,true,true);
         }
      ...
      public static function create(param1:uint, param2:String, param3:String, param4:GuildEmblem, param5:Number = 0, param6:uint = 0, param7:uint = 0, param8:Vector.<GuildFactSheetWrapper> = null, param9:Vector.<uint> = null, param10:Number = 0, param11:String = "") : AllianceWrapper
      {
         ...
         if(param4 != null)
         {
            _loc12_.upEmblem = EmblemWrapper.create(param4.symbolShape,EmblemWrapper.UP,param4.symbolColor,true);
            _loc12_.backEmblem = EmblemWrapper.create(param4.backgroundShape,EmblemWrapper.BACK,param4.backgroundColor,true);
         }
      ...
      public function update(param1:uint, param2:String, param3:String, param4:GuildEmblem, param5:Number = 0, param6:uint = 0, param7:uint = 0, param8:Vector.<GuildFactSheetWrapper> = null, param9:Vector.<uint> = null, param10:Number = 0, param11:String = "") : void
      {
