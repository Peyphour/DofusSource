package com.ankamagames.dofus.internalDatacenter.conquest
{
   ...
   public class AllianceOnTheHillWrapper implements IDataCenter
   {
      ...
      public static function create(param1:uint, param2:String, param3:String, param4:GuildEmblem, param5:uint, param6:uint, param7:uint, param8:uint) : AllianceOnTheHillWrapper
      {
         ...
         if(param4 != null)
         {
            _loc9_.upEmblem = EmblemWrapper.create(param4.symbolShape,EmblemWrapper.UP,param4.symbolColor,true);
            _loc9_.backEmblem = EmblemWrapper.create(param4.backgroundShape,EmblemWrapper.BACK,param4.backgroundColor,true);
         }
