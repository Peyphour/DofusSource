package com.ankamagames.dofus.types.entities
{
   ...
   public class AnimatedCharacter extends TiphonSprite implements IEntity, IMovable, IDisplayable, IAnimated, IInteractive, IRectangle, IObstacle, ITransparency, ICustomUnicNameGetter
   {
      ...
      public function AnimatedCharacter(param1:Number, param2:TiphonEntityLook, param3:AnimatedCharacter = null)
      {
         this.id = param1;
      ...
      override public function removeSubEntity(param1:DisplayObject) : void
      {
         var _loc2_:TiphonSprite = param1 as TiphonSprite;
         if(this._auraEntity && _loc2_ && this._auraEntity.look.toString() == _loc2_.look.toString())
         {
            this._auraEntity = null;
         }
         super.removeSubEntity(param1);
      }
