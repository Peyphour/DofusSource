package com.ankamagames.dofus.types.entities
{
   ...
   public class Projectile extends TiphonSprite implements IDisplayable, IMovable, IEntity, ITransparency
   {
      ...
      public function Projectile(param1:Number, param2:TiphonEntityLook, param3:Boolean = false, param4:Boolean = true)
      {
         super(param2);
      ...
      public function init(param1:int = -1) : void
      {
         ...
         setDirection(param1 == -1?uint(DirectionsEnum.RIGHT):uint(param1));
