package com.ankamagames.dofus.datacenter.items
{
   ...
   public class ItemSet#905 implements IDataCenter
   {
      ...
      public function ItemSet#905()
      {
         super();
      }
      
      public static function getItemSetById(param1:uint) : ItemSet#905
      {
         return GameData.getObject(MODULE,param1) as ItemSet#905;
      }
