package com.ankamagames.dofus.datacenter.effects
{
   ...
   public class EffectInstance implements IDataCenter
   {
      ...
      private function prepareDescription(param1:String, param2:uint, param3:Boolean = false, param4:Boolean = false) : String
      {
         ...
         if(param1.indexOf("#") != -1)
         {
            _loc7_ = [this.parameter0,this.parameter1,this.parameter2,this.parameter3,this.parameter4];
            if(this.parameter0 > 0 && this.parameter1 > 0 && this.bonusType == -1)
            {
               _loc7_ = [this.parameter1,this.parameter0,this.parameter2,this.parameter3,this.parameter4];
            }
            switch(param2)
            {
               case 10:
                  _loc7_[2] = this.getEmoticonName(_loc7_[0]);
                  break;
               case 165:
               case 1084:
               case 1179:
                  _loc7_[0] = this.getItemTypeName(_loc7_[0]);
                  break;
               case 197:
               case 181:
               case 185:
               case 405:
               case 2796:
                  _loc7_[0] = this.getMonsterName(_loc7_[0]);
                  break;
               case 220:
               ...
               case 294:
               case 1160:
                  _loc7_[0] = this.getSpellName(_loc7_[0]);
                  break;
               case 1175:
                  _loc7_[0] = "{spellNoLvl," + _loc7_[0] + "," + _loc7_[1] + "}";
                  break;
               case 406:
                  _loc7_[2] = this.getSpellName(_loc7_[2]);
                  break;
               case 604:
                  if(_loc7_[2] == null)
                  {
                  ...
                  _loc7_[2] = this.getSpellLevelName(_loc7_[2]);
                  break;
               case 614:
               case 1050:
                  _loc7_[0] = _loc7_[2];
                  _loc7_[1] = this.getJobName(_loc7_[1]);
                  break;
               case 616:
               case 624:
                  _loc7_[2] = this.getSpellName(_loc7_[0]);
                  break;
               case 620:
                  _loc7_[2] = this.getDocumentTitle(_loc7_[0]);
                  break;
               case 621:
                  _loc7_[2] = this.getMonsterName(_loc7_[1]);
                  break;
               case 623:
               case 628:
                  _loc7_[1] = this.getMonsterGrade(_loc7_[2],_loc7_[0]);
                  _loc7_[2] = this.getMonsterName(_loc7_[2]);
                  break;
               case 649:
               case 960:
                  _loc7_[2] = this.getAlignmentSideName(_loc7_[0]);
                  break;
               case 669:
                  break;
               case 699:
                  _loc7_[0] = this.getJobName(_loc7_[0]);
                  break;
               case 706:
                  break;
               case 715:
                  _loc7_[0] = this.getMonsterSuperRaceName(_loc7_[0]);
                  break;
               case 716:
                  _loc7_[0] = this.getMonsterRaceName(_loc7_[0]);
                  break;
               case 717:
               case 1008:
               case 1011:
                  ...
                  break;
               case 724:
                  _loc7_[2] = this.getTitleName(_loc7_[0]);
                  break;
               case 787:
               case 792:
               case 793:
               ...
               case 806:
                  if(_loc7_[1] > 6)
                  {
                     _loc7_[0] = I18n.getUiText("ui.petWeight.fat",[_loc7_[1]]);
                  }
                  else if(_loc7_[2] > 6)
                  {
                     _loc7_[0] = I18n.getUiText("ui.petWeight.lean",[_loc7_[2]]);
                  }
                  else if(this is EffectInstanceInteger && _loc7_[0] > 6)
                  {
                     _loc7_[0] = I18n.getUiText("ui.petWeight.lean",[_loc7_[0]]);
                  }
                  else
                  {
                     _loc7_[0] = I18n.getUiText("ui.petWeight.nominal");
                  }
                  break;
               case 807:
                  if(_loc7_[0])
                  {
                     _loc7_[0] = this.getItemName(_loc7_[0]);
                  }
                  else
                  {
                     _loc7_[0] = I18n.getUiText("ui.common.none");
                  }
                  break;
               case 814:
               case 1151:
               ...
               case 1187:
                  ...
                  break;
               case 1188:
                  _loc7_[0] = this.getMountFamilyName(_loc7_[0]);
                  break;
               case 905:
                  _loc7_[1] = this.getMonsterName(_loc7_[1]);
                  break;
               case 939:
               case 940:
                  _loc7_[2] = this.getItemName(_loc7_[0]);
                  break;
               case 950:
               case 951:
               case 952:
                  _loc8_ = _loc7_[2] != null?SpellState.getSpellStateById(_loc7_[2]):SpellState.getSpellStateById(_loc7_[0]);
                  if(_loc8_)
                  {
                     if(_loc8_.isSilent)
                     {
                     ...
                     _loc7_[2] = _loc8_.name;
                  }
                  else
                  {
                     _loc7_[2] = UNKNOWN_NAME;
                  }
                  break;
               case 961:
               case 962:
               ...
               case 985:
               case 996:
                  _loc7_[3] = "{player," + _loc7_[3] + "}";
                  break;
               case 1111:
                  _loc7_[2] = _loc7_[0];
                  break;
               case 1161:
                  _loc7_[0] = this.getCompanionName(_loc7_[0]);
                  break;
               case 805:
               case 808:
               case 983:
                  if(_loc7_[0] == undefined && _loc7_[1] == undefined && _loc7_[2] > 0)
                  {
                     _loc7_[0] = _loc7_[2];
                     break;
                  }
                  if(_loc7_[0] == null && _loc7_[1] == null && _loc7_[2] == null)
                  {
                     break;
                  }
                  _loc7_[2] = _loc7_[2] == undefined?0:_loc7_[2];
                  _loc9_ = _loc7_[0];
                  _loc10_ = _loc7_[1].substr(0,2);
                  _loc11_ = _loc7_[1].substr(2,2);
                  _loc12_ = _loc7_[2].substr(0,2);
                  _loc13_ = _loc7_[2].substr(2,2);
                  _loc14_ = XmlConfig.getInstance().getEntry("config.lang.current");
                  switch(_loc14_)
                  {
                     case LanguageEnum.LANG_FR:
                        _loc7_[0] = _loc11_ + "/" + _loc10_ + "/" + _loc9_ + " " + _loc12_ + ":" + _loc13_;
                        break;
                     case LanguageEnum.LANG_EN:
                        _loc7_[0] = _loc10_ + "/" + _loc11_ + "/" + _loc9_ + " " + _loc12_ + ":" + _loc13_;
                        break;
                     default:
                        _loc7_[0] = _loc10_ + "/" + _loc11_ + "/" + _loc9_ + " " + _loc12_ + ":" + _loc13_;
                  }
            ...
            if(param3 && _loc7_)
            {
               ...
               {
                  _loc6_ = true;
                  _loc7_[1] = _loc7_[1] + "</span>";
               }
               else if(_loc7_[0] != null)
               {
                  _loc6_ = true;
                  _loc7_[0] = _loc7_[0] + "</span>";
               }
            }
            _loc5_ = PatternDecoder.getDescription(param1,_loc7_);
         ...
         if(param3)
         {
            if(_loc6_ && _loc5_.indexOf("</span>") != -1)
            {
               if(param4)
               {
                  _loc15_ = param1.indexOf("#");
                  _loc16_ = param1.lastIndexOf("#");
                  if(_loc15_ != _loc16_ && _loc15_ >= 0 && _loc16_ >= 0)
                  {
