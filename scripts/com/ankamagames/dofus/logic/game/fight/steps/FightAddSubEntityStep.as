package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightAddSubEntityStep extends AbstractSequencable implements IFightStep
   {
      ...
      public function FightAddSubEntityStep(param1:Number, param2:Number, param3:uint, param4:uint, param5:ISubEntityBehavior = null)
      {
         super();
      ...
      override public function start() : void
      {
         ...
         if(_loc2_ && _loc3_ && _loc3_ is TiphonSprite)
         {
            ...
            if(_loc3_.getTmpSubEntitiesNb() > 0 && !_loc3_.libraryIsAvailable)
            {
