package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightCarryCharacterStep extends AbstractSequencable implements IFightStep
   {
      ...
      public function FightCarryCharacterStep(param1:Number, param2:Number, param3:int = -1, param4:Boolean = false)
      {
         super();
      ...
      override public function start() : void
      {
         ...
         var _loc13_:uint = 0;
         var _loc14_:FightEntitiesFrame = null;
         ...
         if(_loc3_ is TiphonSprite)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc13_ = _loc2_.advancedOrientationTo(_loc8_);
               if(!_loc10_ && !_loc11_)
               {
                  this._carrySubSequence.addStep(new SetDirectionStep(_loc3_.rootEntity,_loc13_));
               }
               this.updateCarriedEntityPosition(_loc3_ as IMovable,_loc4_ as IMovable);
               _loc14_ = Kernel.getWorker().getFrame(FightEntitiesFrame) as FightEntitiesFrame;
               _loc15_ = _loc14_.getEntityInfos(_loc4_.id) as GameFightFighterInformations;
               if(_loc15_)
               {
                  _loc15_.disposition.cellId = _loc4_.position.cellId;
                  _loc15_.disposition.direction = _loc13_;
               }
            }
         }
