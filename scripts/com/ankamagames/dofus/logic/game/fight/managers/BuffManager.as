package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class BuffManager
   {
      ...
      public static function makeBuffFromEffect(param1:AbstractFightDispellableEffect, param2:CastingSpell, param3:uint) : BasicBuff
      {
         ...
         switch(true)
         {
            ...
            case param1 is FightTemporaryBoostEffect:
               _loc4_ = StatBuffFactory.createStatBuff(param1 as FightTemporaryBoostEffect,param2,param3);
         }
         ...
         if(_loc5_.length > 0)
         {
            ...
            for each(_loc11_ in _loc10_)
            {
               if(_loc11_.effectUid == param1.effectId)
               {
                  ...
                  _loc4_.effect.targetMask = _loc11_.targetMask;
                  _loc4_.effect.effectElement = _loc11_.effectElement;
                  break;
               }
            }
         }
      ...
      public function decrementDuration(param1:Number) : void
      {
         this.incrementDuration(param1,-1);
      }
      
      public function synchronize(param1:Number = 0) : void
      {
         var _loc2_:* = null;
      ...
      public function incrementDuration(param1:Number, param2:int, param3:Boolean = false, param4:int = 1) : void
      {
      ...
      public function markFinishingBuffs(param1:Number, param2:Boolean = false) : void
      {
         var _loc3_:BasicBuff = null;
      ...
      {
         var _loc3_:BasicBuff = null;
         var _loc2_:Number = param1.targetId;
      ...
      public function dispell(param1:Number, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false) : void
      {
         var _loc7_:BasicBuff = null;
         var _loc5_:Array = new Array();
      ...
      public function dispellSpell(param1:Number, param2:uint, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
      ...
      public function dispellUniqueBuff(param1:Number, param2:int, param3:Boolean = false, param4:Boolean = false, param5:Boolean = true) : void
      {
         var _loc8_:Boolean = false;
         ...
         if(_loc7_.canBeDispell(param3,!!param5?int(param2):int(int.MIN_VALUE),param4))
         {
      ...
      public function removeLinkedBuff(param1:Number, param2:Boolean = false, param3:Boolean = false) : Array
      {
      ...
      public function reaffectBuffs(param1:Number) : void
      {
      ...
      private function getNextFighter(param1:Number) : Number
      {
      ...
      public function getFighterInfo(param1:Number) : GameFightFighterInformations
      {
         return this.fightEntitiesFrame.getEntityInfos(param1) as GameFightFighterInformations;
      }
      
      public function getAllBuff(param1:Number) : Array
      {
         return this._buffs[param1];
      }
      
      public function getBuff(param1:uint, param2:Number) : BasicBuff
      {
         var _loc3_:BasicBuff = null;
      ...
      public function getFinishingBuffs(param1:Number) : Array
      {
      ...
      private function getBuffIndex(param1:Number, param2:int) : int
      {
         var _loc3_:* = null;
         var _loc4_:BasicBuff = null;
