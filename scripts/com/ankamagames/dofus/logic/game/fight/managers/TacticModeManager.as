package com.ankamagames.dofus.logic.game.fight.managers
{
   ...
   public class TacticModeManager
   {
      ...
      public function TacticModeManager(param1:PrivateClass#3116)
      {
         super();
      ...
      public static function getInstance() : TacticModeManager
      {
         if(_self == null)
         {
            _self = new TacticModeManager(new PrivateClass#3116());
         }
         return _self;
      }
      ...
      public function show(param1:WorldPointWrapper, param2:Boolean = false) : void
      {
         ...
         else
         {
            ...
            if(!this._debugMode || this._showBlockMvt)
            {
               ...
               this._tacticUnreachableRangeSelection.renderer = new ZoneClipRenderer(PlacementStrataEnums.STRATA_AREA,SWF_LIB,TILES_NO_VIEW,TILES_NO_VIEW.length > 1?int(this._currentMapId):-1,SHOW_BLOC_MOVE);
...
class PrivateClass#3116
{
    
   
   function PrivateClass#3116()
   {
      super();
   }
}
