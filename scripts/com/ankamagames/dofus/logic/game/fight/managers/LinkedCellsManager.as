   ...
   public class LinkedCellsManager implements IDestroyable
   {
      ...
      public function drawPortalLinks(param1:Vector.<uint>) : void
      {
         ...
         if(param1 && param1.length)
         {
            ...
            _loc3_.renderer = new CellLinkRenderer(10,0.5,true,!!Atouin.getInstance().options.transparentOverlayMode?uint(PlacementStrataEnums.STRATA_NO_Z_ORDER):uint(PlacementStrataEnums.STRATA_LINK));
