package com.ankamagames.dofus.logic.game.fight.types
{
   ...
   public class SwapPositionRequest
   {
      ...
      public function SwapPositionRequest(param1:uint, param2:Number, param3:Number)
      {
         super();
      ...
      {
         var _loc1_:AnimatedCharacter = DofusEntities.getEntity(!!this._isRequesterIcon?Number(this.requesterId):Number(this.requestedId)) as AnimatedCharacter;
      ...
      {
         var _loc1_:Number = !!this._isRequesterIcon?Number(this.requesterId):Number(this.requestedId);
      ...
      private function placeIcon(param1:AnimatedCharacter) : void
      {
         ...
         if(_loc3_)
         {
            _loc8_ = !!TooltipManager.isVisible("tooltipOverEntity_" + param1.id)?Number(70):Number(10);
