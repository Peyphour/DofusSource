package com.ankamagames.dofus.logic.game.fight.types.castSpellManager
{
   ...
   public class SpellManager
   {
      ...
      public function getCastOnEntity(param1:Number) : uint
      {
      ...
      public function forceCooldown(param1:int) : void
      {
         ...
         var _loc4_:SpellWrapper = SpellWrapper.getSpellWrapperById(this._spellId,this._spellCastManager.entityId);
         _loc4_.actualCooldown = param1;
      }
      ...
      {
         var _loc2_:SpellWrapper = SpellWrapper.getSpellWrapperById(this._spellId,this._spellCastManager.entityId);
         var _loc3_:Spell = Spell.getSpellById(this._spellId);
         var _loc4_:SpellLevel = _loc3_.getSpellLevel(this._spellLevel);
         if(_loc2_ && _loc2_.actualCooldown != 63)
         {
