package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   import com.ankamagames.dofus.datacenter.notifications.Notification#31;
   ...
   public class ChatFrame implements Frame
   {
      ...
      public function pushed() : Boolean
      {
         ...
         for each(_loc2_ in this._aSmileyPacks)
         {
            ...
            {
               _loc1_ = Smiley#7797.getSmileyById(_loc11_);
               if(_loc1_)
               {
      ...
      public function getUnsoldItems(param1:uint) : Array
      {
         return this._unsoldItems[param1];
      }
      ...
      public function set sendingSplittedContent(param1:Boolean) : void
      {
         this._sendingSplittedContent = param1;
      }
      ...
      public function set splittedContent(param1:String) : void
      {
         this._splittedContent = param1;
      }
      ...
      public function set splittedContentLength(param1:uint) : void
      {
         this._splittedContentLength = param1;
      }
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case msg is ChatSmileyExtraPackListMessage:
               ...
               for each(pack in this._aSmileyPacks)
               {
                  if(pack)
                  {
                     ...
                     {
                        smiley = Smiley#7797.getSmileyById(smileypId);
                        if(smiley)
                        {
            ...
            case msg is NotificationByServerMessage:
               ...
               notification = Notification#31.getNotificationById(nbsmsg.id);
      ...
      private function onCssLoaded(param1:String) : void
      {
         ...
         while(_loc4_ < 13)
         {
            _loc3_ = _loc2_.getStyle("p" + _loc4_);
            this._aChatColors[_loc4_] = uint(this.color0x(_loc3_["color"]));
            _loc4_++;
         }
         _loc3_ = _loc2_.getStyle("p");
         this._aChatColors.push(uint(this.color0x(_loc3_["color"])));
      }
      ...
      private function saveMessage(param1:int = 0, param2:String = "", param3:String = "", param4:Number = 0, param5:String = "", param6:Number = 0, param7:String = "", param8:Vector.<ItemWrapper> = null, param9:String = "", param10:Number = 0, param11:uint = 0, param12:Array = null, param13:Boolean = false) : void
      {
      ...
      public function checkCensored(param1:String, param2:uint, param3:Number, param4:String) : Array
      {
         ...
         {
            _loc16_ = XmlConfig.getInstance().getEntry("config.lang.current");
            _loc17_ = "";
            _loc18_ = ["&","%","?","#","§","!"];
            _loc19_ = _loc16_ == "ja";
            if(!_loc19_)
            {
               ...
               {
                  _loc22_ = _loc21_.toLowerCase();
                  _loc23_ = "";
                  if(this._aCensoredWords)
                  {
                     if(this._aCensoredWords[_loc22_])
                     {
                        _loc24_ = 0;
                        while(_loc24_ < _loc22_.length)
                        {
                           _loc23_ = _loc23_ + _loc18_[_loc22_.charCodeAt(_loc24_) % 5];
                           _loc24_++;
                        }
                     }
                     else
                     {
                        for(_loc25_ in this._aCensoredWords)
                        {
                           if(this._aCensoredWords[_loc25_] == 2)
                           {
                              if(_loc22_.indexOf(_loc25_) != -1)
                              {
                                 _loc26_ = 0;
                                 while(_loc26_ < _loc22_.length)
                                 {
                                    _loc23_ = _loc23_ + _loc18_[_loc22_.charCodeAt(_loc26_) % 5];
                                    _loc26_++;
                                 }
                                 continue;
                              }
                  ...
                  _loc17_ = _loc17_ + (_loc23_ + " ");
               }
               _loc5_ = _loc17_.slice(0,_loc17_.length - 1);
            }
            else
            {
               _loc27_ = "&%?§!&?&%§!&%!&%?#§!";
               _loc28_ = _loc5_.toUpperCase();
               for(_loc29_ in this._aCensoredWords)
               {
                  _loc30_ = 0;
                  while(_loc30_ != -1)
                  {
                     _loc30_ = _loc28_.indexOf(_loc29_);
                     if(_loc30_ != -1)
                     {
                        _loc5_ = _loc5_.substr(0,_loc30_) + _loc27_.substr(0,_loc29_.length) + _loc5_.substr(_loc30_ + _loc29_.length);
                        _loc28_ = _loc5_.toUpperCase();
                     }
                  }
               }
         ...
         {
            _loc31_ = "";
            _loc32_ = this.needToFormateUrl(_loc13_);
            if(_loc32_.formate)
            {
               _loc31_ = _loc31_ + HtmlManager.addLink("[" + _loc32_.url + "]","event:chatLinkRelease," + _loc32_.url + "," + param3 + "," + param4,{"bold":true});
               _loc9_ = true;
            }
            if(_loc31_ == "")
            {
            ...
            _loc8_ = _loc8_ + (_loc31_ + " ");
         }
         _loc5_ = _loc8_.slice(0,_loc8_.length - 1);
         _loc14_ = 0;
         _loc15_ = new Array();
         if(_loc14_ > 0)
         {
            _loc33_ = I18n.getUiText("ui.popup.warning");
            _loc15_[0] = _loc5_ + " [" + HtmlManager.addLink(I18n.getUiText("ui.popup.warning"),"event:chatWarning",{"color":XmlConfig.getInstance().getEntry("colors.hyperlink.warning")}) + "]";
            _loc15_[1] = _loc5_ + " [" + _loc33_ + "]";
         }
         else
         {
            _loc15_[0] = _loc5_;
