package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class AllianceFrame implements Frame
   {
      ...
      public function _pickup_fighter(param1:Array, param2:Number) : PrismFightersWrapper
      {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc90_:AllianceMotdSetRequestAction = null;
         var _loc91_:AllianceMotdSetRequestMessage = null;
         var _loc92_:AllianceMotdMessage = null;
         var _loc93_:String = null;
         var _loc94_:RegExp = null;
         var _loc95_:Array = null;
         var _loc96_:AllianceMotdSetErrorMessage = null;
         var _loc97_:String = null;
         var _loc98_:AllianceBulletinSetRequestAction = null;
         var _loc99_:AllianceBulletinSetRequestMessage = null;
         var _loc100_:AllianceBulletinMessage = null;
         var _loc101_:Array = null;
         var _loc102_:AllianceBulletinSetErrorMessage = null;
         var _loc103_:PrismSubAreaWrapper = null;
         var _loc104_:PrismSubAreaWrapper = null;
         var _loc105_:int = 0;
         var _loc106_:Number = NaN;
         var _loc107_:UpdateSelfAgressableStatusMessage = null;
         var _loc108_:GuildInAllianceInformations = null;
         var _loc109_:GuildInsiderFactSheetInformations = null;
         var _loc110_:PrismSubareaEmptyInfo = null;
         var _loc111_:SocialEntityInFightWrapper = null;
         var _loc112_:Object = null;
         var _loc113_:Object = null;
         var _loc114_:PrismsListRegisterMessage = null;
         var _loc115_:String = null;
         var _loc116_:PrismSubareaEmptyInfo = null;
         var _loc117_:int = 0;
         var _loc118_:int = 0;
         var _loc119_:* = null;
         ...
         switch(true)
         {
            case param1 is CurrentMapMessage:
               ...
               if(PlayedCharacterManager.getInstance().currentSubArea && _loc4_ && _loc3_ && _loc4_.id != _loc3_.id)
               {
                  if(!PrismSubAreaWrapper.prismList[_loc3_.id] && PrismSubAreaWrapper.prismList[_loc4_.id])
                  {
                     _loc103_ = PrismSubAreaWrapper.prismList[_loc4_.id];
                     if(_loc103_.state == PrismStateEnum.PRISM_STATE_VULNERABLE)
                     {
                        KernelEventsManager.getInstance().processCallback(PrismHookList.KohState,_loc103_);
                     }
                  }
                  if(PrismSubAreaWrapper.prismList[_loc3_.id] && !PrismSubAreaWrapper.prismList[_loc4_.id])
                  {
                     _loc104_ = PrismSubAreaWrapper.prismList[_loc3_.id];
                     if(_loc104_.state == PrismStateEnum.PRISM_STATE_VULNERABLE)
                     {
            ...
            case param1 is KohUpdateMessage:
               ...
               _loc105_ = 0;
               while(_loc105_ < _loc8_)
               {
                  if(_loc7_.alliances[_loc105_].allianceId == _loc12_)
                  {
                     _loc9_ = SIDE_MINE;
                  }
                  else if(_loc7_.alliances[_loc105_].allianceId == _loc10_)
                  {
                  ...
                  _loc11_ = AllianceOnTheHillWrapper.create(_loc7_.alliances[_loc105_].allianceId,_loc7_.alliances[_loc105_].allianceTag,_loc7_.alliances[_loc105_].allianceName,_loc7_.alliances[_loc105_].allianceEmblem,_loc7_.allianceNbMembers[_loc105_],_loc7_.allianceRoundWeigth[_loc105_],_loc7_.allianceMatchScore[_loc105_],_loc9_);
            ...
            case param1 is AllianceLeftMessage:
               ...
               if(_loc27_)
               {
                  for each(_loc106_ in _loc27_.playersId)
                  {
                     _loc27_.removeIconsCategory(_loc106_,EntityIconEnum.AVA_CATEGORY);
                  }
                  _loc107_ = new UpdateSelfAgressableStatusMessage();
                  _loc107_.initUpdateSelfAgressableStatusMessage(AggressableStatusEnum.NON_AGGRESSABLE);
                  _loc27_.process(_loc107_);
               }
            ...
            case param1 is AllianceFactsMessage:
               ...
               for each(_loc108_ in _loc30_.guilds)
               {
                  _loc33_ = _loc35_.getGuildById(_loc108_.guildId);
                  if(_loc33_)
                  {
                     _loc33_.update(_loc108_.guildId,_loc108_.guildName,_loc108_.guildEmblem,_loc33_.leaderId,_loc33_.leaderName,_loc108_.guildLevel,_loc108_.nbMembers,_loc33_.creationDate,_loc33_.members,_loc33_.nbConnectedMembers,_loc33_.nbTaxCollectors,_loc33_.lastActivity,_loc30_.infos.allianceId,_loc30_.infos.allianceName,_loc30_.infos.allianceTag,_loc44_);
                  }
                  else
                  {
                     _loc33_ = GuildFactSheetWrapper.create(_loc108_.guildId,_loc108_.guildName,_loc108_.guildEmblem,0,"",_loc108_.guildLevel,_loc108_.nbMembers,0,null,0,0,0,_loc30_.infos.allianceId,_loc30_.infos.allianceName,_loc30_.infos.allianceTag,_loc44_);
                  }
                  _loc34_ = _loc34_ + _loc108_.nbMembers;
                  _loc35_.updateGuildById(_loc108_.guildId,_loc33_);
            ...
            case param1 is AllianceInsiderInfoMessage:
               ...
               for each(_loc109_ in _loc41_.guilds)
               {
                  _loc43_ = _loc47_.getGuildById(_loc109_.guildId);
                  if(_loc43_)
                  {
                     _loc43_.update(_loc109_.guildId,_loc109_.guildName,_loc109_.guildEmblem,_loc109_.leaderId,_loc109_.leaderName,_loc109_.guildLevel,_loc109_.nbMembers,_loc43_.creationDate,_loc43_.members,_loc109_.nbConnectedMembers,_loc109_.nbTaxCollectors,_loc109_.lastActivity,_loc41_.allianceInfos.allianceId,_loc41_.allianceInfos.allianceName,_loc41_.allianceInfos.allianceTag,_loc44_);
                  }
                  else
                  {
                     _loc43_ = GuildFactSheetWrapper.create(_loc109_.guildId,_loc109_.guildName,_loc109_.guildEmblem,_loc109_.leaderId,_loc109_.leaderName,_loc109_.guildLevel,_loc109_.nbMembers,0,null,_loc109_.nbConnectedMembers,_loc109_.nbTaxCollectors,_loc109_.lastActivity,_loc41_.allianceInfos.allianceId,_loc41_.allianceInfos.allianceName,_loc41_.allianceInfos.allianceTag,_loc44_);
                  }
                  _loc46_ = _loc46_ + _loc109_.nbMembers;
                  _loc47_.updateGuildById(_loc109_.guildId,_loc43_);
                  _loc42_.push(_loc43_);
                  _loc44_ = false;
               }
               for each(_loc110_ in _loc41_.prisms)
               {
                  if(_loc110_ is PrismGeolocalizedInformation && (_loc110_ as PrismGeolocalizedInformation).prism is AllianceInsiderPrismInformation)
                  {
                     _loc45_.push(_loc110_.subAreaId);
                  }
               }
            ...
            case param1 is PrismFightJoinLeaveRequestAction:
               ...
               {
                  for each(_loc111_ in TaxCollectorsManager.getInstance().prismsFighters)
                  {
                     for each(_loc112_ in _loc111_.allyCharactersInformations)
                     {
                        if(_loc112_.playerCharactersInformations.id == PlayedCharacterManager.getInstance().id)
                        {
                           this._autoLeaveHelpers = true;
                           _loc54_.initPrismFightJoinLeaveRequestMessage(_loc111_.uniqueId,_loc53_.join);
            ...
            case param1 is PrismsListRegisterAction:
               ...
               else
               {
                  ...
                  for each(_loc113_ in this._prismsListeners)
                  {
                     if(_loc113_ == PrismListenEnum.PRISM_LISTEN_MINE)
                     {
                        _loc62_ = PrismListenEnum.PRISM_LISTEN_MINE;
                        break;
                     }
                     if(_loc113_ == PrismListenEnum.PRISM_LISTEN_ALL)
                     {
               ...
               if(_loc60_)
               {
                  _loc114_ = new PrismsListRegisterMessage();
                  _loc114_.initPrismsListRegisterMessage(_loc62_);
                  ConnectionsHandler.getConnection().send(_loc114_);
            ...
            case param1 is PrismFightDefenderLeaveMessage:
               ...
               {
                  _loc115_ = I18n.getUiText("ui.prism.AutoDisjoin");
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc115_,ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO,TimeManager.getInstance().getTimestamp());
               }
            ...
            case param1 is PrismsListUpdateMessage:
               ...
               _loc78_ = new Array();
               for each(_loc116_ in _loc77_.prisms)
               {
                  if(_loc116_ is PrismGeolocalizedInformation && (_loc116_ as PrismGeolocalizedInformation).prism is AllianceInsiderPrismInformation)
                  {
                     _loc81_ = _loc116_ as PrismGeolocalizedInformation;
                     _loc82_ = _loc81_.prism as AllianceInsiderPrismInformation;
                     _loc79_ = PrismSubAreaWrapper.prismList[_loc116_.subAreaId];
                     _loc117_ = _loc81_.worldX;
                     _loc118_ = _loc81_.worldY;
                     _loc119_ = SubArea.getSubAreaById(_loc81_.subAreaId).name + " (" + SubArea.getSubAreaById(_loc81_.subAreaId).area.name + ")";
                     if(_loc82_.state == PrismStateEnum.PRISM_STATE_SABOTAGED && _loc79_ && _loc79_.state != PrismStateEnum.PRISM_STATE_SABOTAGED)
                     {
                        _loc120_ = I18n.getUiText("ui.prism.sabotaged",[_loc119_,_loc117_ + "," + _loc118_]);
                        KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc120_,ChatActivableChannelsEnum.CHANNEL_ALLIANCE,TimeManager.getInstance().getTimestamp());
                     }
                     else if(_loc82_.state == PrismStateEnum.PRISM_STATE_ATTACKED && _loc79_ && _loc79_.state != PrismStateEnum.PRISM_STATE_ATTACKED)
                     {
                        _loc120_ = I18n.getUiText("ui.prism.attacked",[_loc119_,_loc117_ + "," + _loc118_]);
                        KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,"{openSocial,2,2,1," + _loc81_.subAreaId + "::" + _loc120_ + "}",ChatActivableChannelsEnum.CHANNEL_ALLIANCE,TimeManager.getInstance().getTimestamp());
                        ...
                        {
                           KernelEventsManager.getInstance().processCallback(HookList.ExternalNotification,ExternalNotificationTypeEnum.PRISM_ATTACK,[_loc119_,_loc81_.worldX + "," + _loc81_.worldY]);
                        }
                        if(OptionManager.getOptionManager("dofus")["warnOnGuildItemAgression"])
                        {
                           _loc121_ = NotificationManager.getInstance().prepareNotification(I18n.getUiText("ui.prism.attackedNotificationTitle"),I18n.getUiText("ui.prism.attackedNotification",[SubArea.getSubAreaById(_loc81_.subAreaId).name,_loc81_.worldX + "," + _loc81_.worldY]),NotificationTypeEnum.INVITATION,"PrismAttacked");
                           NotificationManager.getInstance().addButtonToNotification(_loc121_,I18n.getUiText("ui.common.join"),"OpenSocial",[2,2,[1,_loc81_.subAreaId]],false,200,0,"hook");
                           NotificationManager.getInstance().sendNotification(_loc121_);
                        }
                     }
                     else if(_loc79_ && _loc79_.state == PrismStateEnum.PRISM_STATE_FIGHTING && _loc82_.state != PrismStateEnum.PRISM_STATE_FIGHTING)
                     {
                        if(_loc82_.state == PrismStateEnum.PRISM_STATE_NORMAL)
                        {
                           _loc120_ = I18n.getUiText("ui.prism.notDefeated",[_loc119_,_loc117_ + "," + _loc118_]);
                        }
                        else if(_loc82_.state == PrismStateEnum.PRISM_STATE_WEAKENED)
                        {
                           _loc120_ = I18n.getUiText("ui.prism.weakened",[_loc119_,_loc117_ + "," + _loc118_]);
                        }
                        KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc120_,ChatActivableChannelsEnum.CHANNEL_ALLIANCE,TimeManager.getInstance().getTimestamp());
                     }
                  }
                  _loc78_.push(_loc116_.subAreaId);
                  PrismSubAreaWrapper.getFromNetwork(_loc116_,this._alliance);
               }
            ...
            case param1 is PrismsListMessage:
               ...
               _loc85_ = _loc84_.prisms.length;
               _loc122_ = 0;
               while(_loc122_ < _loc85_)
               {
                  PrismSubAreaWrapper.getFromNetwork(_loc84_.prisms[_loc122_],this._alliance);
                  _loc122_++;
               }
            ...
            case param1 is AlliancePrismDialogQuestionMessage:
               ...
               return true;
            case param1 is AllianceMotdSetRequestAction:
               _loc90_ = param1 as AllianceMotdSetRequestAction;
               _loc91_ = new AllianceMotdSetRequestMessage();
               _loc91_.initAllianceMotdSetRequestMessage(_loc90_.content);
               ConnectionsHandler.getConnection().send(_loc91_);
               return true;
            case param1 is AllianceMotdMessage:
               _loc92_ = param1 as AllianceMotdMessage;
               _loc93_ = _loc92_.content;
               _loc94_ = /</g;
               _loc93_ = _loc93_.replace(_loc94_,"&lt;");
               _loc95_ = (Kernel.getWorker().getFrame(ChatFrame) as ChatFrame).checkCensored(_loc93_,ChatActivableChannelsEnum.CHANNEL_ALLIANCE,_loc92_.memberId,_loc92_.memberName);
               this._alliance.motd = _loc92_.content;
               this._alliance.formattedMotd = _loc95_[0];
               this._alliance.motdWriterId = _loc92_.memberId;
               this._alliance.motdWriterName = _loc92_.memberName;
               this._alliance.motdTimestamp = _loc92_.timestamp;
               KernelEventsManager.getInstance().processCallback(SocialHookList.AllianceMotd);
               if(_loc92_.content != "" && !OptionManager.getOptionManager("dofus")["disableAllianceMotd"])
               {
                  _loc123_ = I18n.getUiText("ui.motd.alliance") + I18n.getUiText("ui.common.colon") + _loc95_[0];
                  KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc123_,ChatActivableChannelsEnum.CHANNEL_ALLIANCE,TimeManager.getInstance().getTimestamp());
               }
               return true;
            case param1 is AllianceMotdSetErrorMessage:
               _loc96_ = param1 as AllianceMotdSetErrorMessage;
               switch(_loc96_.reason)
               {
                  case SocialNoticeErrorEnum.SOCIAL_NOTICE_UNKNOWN_ERROR:
                     _loc97_ = I18n.getUiText("ui.common.unknownFail");
                     break;
                  case SocialNoticeErrorEnum.SOCIAL_NOTICE_COOLDOWN:
                     _loc97_ = I18n.getUiText("ui.motd.errorCooldown");
                     break;
                  case SocialNoticeErrorEnum.SOCIAL_NOTICE_INVALID_RIGHTS:
                     _loc97_ = I18n.getUiText("ui.social.taxCollectorNoRights");
               }
               KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,_loc97_,ChatFrame.RED_CHANNEL_ID,TimeManager.getInstance().getTimestamp());
               return true;
            case param1 is AllianceBulletinSetRequestAction:
               _loc98_ = param1 as AllianceBulletinSetRequestAction;
               _loc99_ = new AllianceBulletinSetRequestMessage();
               _loc99_.initAllianceBulletinSetRequestMessage(_loc98_.content,_loc98_.notifyMembers);
               ConnectionsHandler.getConnection().send(_loc99_);
               return true;
            case param1 is AllianceBulletinMessage:
               _loc100_ = param1 as AllianceBulletinMessage;
               _loc93_ = _loc100_.content;
               _loc94_ = /</g;
               _loc93_ = _loc93_.replace(_loc94_,"&lt;");
               _loc101_ = (Kernel.getWorker().getFrame(ChatFrame) as ChatFrame).checkCensored(_loc93_,ChatActivableChannelsEnum.CHANNEL_ALLIANCE,_loc100_.memberId,_loc100_.memberName);
               this._alliance.bulletin = _loc100_.content;
               this._alliance.formattedBulletin = _loc101_[0];
               this._alliance.bulletinWriterId = _loc100_.memberId;
               this._alliance.bulletinWriterName = _loc100_.memberName;
               this._alliance.bulletinTimestamp = _loc100_.timestamp;
               this._alliance.lastNotifiedTimestamp = _loc100_.lastNotifiedTimestamp;
               KernelEventsManager.getInstance().processCallback(SocialHookList.AllianceBulletin);
               return true;
            case param1 is AllianceBulletinSetErrorMessage:
               _loc102_ = param1 as AllianceBulletinSetErrorMessage;
               switch(_loc102_.reason)
               {
                  case SocialNoticeErrorEnum.SOCIAL_NOTICE_UNKNOWN_ERROR:
                     _loc97_ = I18n.getUiText("ui.common.unknownFail");
                     break;
