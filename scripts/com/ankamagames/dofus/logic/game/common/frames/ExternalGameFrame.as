package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class ExternalGameFrame implements Frame
   {
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         var _loc20_:RoomAvailableUpdateMessage = null;
         var _loc21_:HavenBagPackListMessage = null;
         ...
         switch(true)
         {
            ...
            case param1 is ShopAuthentificationRequestAction:
               ...
               {
                  _loc24_ = UiModuleManager.getInstance().getModule("Ankama_Common").mainClass;
                  _loc24_.openInputPopup("ICE Authentication","To access the Release shop, please enter a valid ICE Token.\nClose this message to access the Local shop.",this.onTokenInput,this.onCancel);
               }
               else
               {
            ...
            case param1 is GetComicsLibraryRequestAction:
               ...
               return true;
            case param1 is RoomAvailableUpdateMessage:
               _loc20_ = param1 as RoomAvailableUpdateMessage;
               PlayerManager.getInstance().havenbagAvailableRooms = _loc20_.nbRoom;
               KernelEventsManager.getInstance().processCallback(HookList.HavenbagAvailableRoomsUpdate,_loc20_.nbRoom);
               return true;
            case param1 is HavenBagPackListMessage:
               _loc21_ = param1 as HavenBagPackListMessage;
               _loc22_ = _loc21_.packIds;
               _loc23_ = _loc22_.indexOf(-1);
               if(_loc23_ != -1)
               {
                  _loc22_.splice(_loc23_,1);
               }
               PlayerManager.getInstance().havenbagAvailableThemes = _loc22_;
               KernelEventsManager.getInstance().processCallback(HookList.HavenbagAvailableThemesUpdate,_loc21_.packIds);
               return true;
            default:
               return false;
         }
