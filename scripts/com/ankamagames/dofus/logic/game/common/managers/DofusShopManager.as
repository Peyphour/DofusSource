package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class DofusShopManager
   {
      ...
      {
         super();
         this._currentShopKey = SteamManager.hasSteamApi() && SteamManager.getInstance().isSteamEmbed()?SHOP_STEAM_KEY:SHOP_KEY;
      }
      ...
      public function init(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc3_:int = CharacterIdConverter.extractServerCharacterIdFromInterserverCharacterId(PlayedCharacterManager.getInstance().id);
         if(SteamManager.hasSteamApi() && SteamManager.getInstance().isSteamEmbed())
         {
            RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "authentification." + this._serviceType,this._serviceType,this._serviceVersion,"SteamByAnkamaToken",[param1,1,SteamManager.getInstance().steamUserId,this._currentLocale,SteamManager.getInstance().steamUserCountry,SteamManager.getInstance().steamUserCurrency,PlayerManager.getInstance().server.id,_loc3_],this.onAuthentification);
         }
         else
         {
            RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "authentification." + this._serviceType,this._serviceType,this._serviceVersion,"AuthenticationByAnkamaToken",[param1,1,PlayerManager.getInstance().server.id,_loc3_],this.onAuthentification);
         }
         this.open();
      }
      ...
      public function buyArticle(param1:int, param2:int = 1) : void
      {
         ...
         RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "shop." + this._serviceType,this._serviceType,this._serviceVersion,"QuickBuy",[this._currentShopKey,this._currentLocale,param1,param2],this.onBuyArticle,true,false);
      }
      
      public function confirmSteamArticlePurchase(param1:int, param2:Boolean) : void
      {
         RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "shop." + this._serviceType,this._serviceType,this._serviceVersion,"PartnerFinalizeTransaction",[this._currentShopKey,this._currentLocale,param2,param1],this.onSteamPurchaseConfirm);
      }
      ...
      public function getArticlesList(param1:int, param2:int = 1, param3:int = 12) : void
      {
         ...
         RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "shop." + this._serviceType,this._serviceType,this._serviceVersion,"ArticlesList",[this._currentShopKey,this._currentLocale,param1,param2,param3],this.onArticlesList,false);
      }
      
      public function searchForArticles(param1:String, param2:int = 1, param3:int = 12) : void
      {
         this._isOnHomePage = false;
         RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "shop." + this._serviceType,this._serviceType,this._serviceVersion,"ArticlesSearch",[this._currentShopKey,this._currentLocale,param1,[],param2,param3],this.onSearchArticles);
      }
      ...
      private function onBuyArticle(param1:Boolean, param2:*, param3:*) : void
      {
         ...
         if(param1)
         {
            ...
            else if(param2.error == "STEAM_NOT_TRUSTED_USER")
            {
      ...
      private function onSteamPurchaseConfirm(param1:Boolean, param2:*, param3:*) : void
      {
         if(param1)
         {
            if(param2.orderstatus == "CANCELED")
            {
      ...
      private function checkPreviousAndNextArticlePages(param1:int, param2:int, param3:int) : void
      {
         ...
         {
            RpcServiceCenter.getInstance().makeRpcCall(this._serviceBaseUrl + "shop." + this._serviceType,this._serviceType,this._serviceVersion,"ArticlesList",[this._currentShopKey,this._currentLocale,param1,param2 - 1,DofusShopEnum.MAX_ARTICLES_PER_PAGE],this.onPreloadArticlesList);
         }
