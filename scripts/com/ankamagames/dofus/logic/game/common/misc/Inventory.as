package com.ankamagames.dofus.logic.game.common.misc
{
   ...
   public class Inventory
   {
      ...
      public function getItem(param1:int) : ItemWrapper
      {
         ...
         {
            return (this._itemsDict[param1] as ItemSet#3111).item;
         }
         return null;
      }
      ...
      public function initialize(param1:Vector.<ItemWrapper>) : void
      {
         ...
         {
            _loc3_ = new ItemSet#3111(_loc2_);
      ...
      public function initializeFromObjectItems(param1:Vector.<ObjectItem>) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            this._itemsDict[_loc7_.objectUID] = new ItemSet#3111(_loc5_);
            _loc2_.push(_loc5_);
            _loc4_++;
         }
      ...
      public function addItem(param1:ItemWrapper) : void
      {
         ...
         {
            _loc2_ = new ItemSet#3111(param1);
      ...
      protected function addItemToViews(param1:ItemSet#3111) : void
      {
      ...
      protected function modifyItemFromViews(param1:ItemSet#3111, param2:ItemWrapper) : void
      {
         var _loc4_:int = 0;
      ...
      protected function removeItemFromViews(param1:ItemSet#3111) : void
      {
         var _loc2_:IInventoryView = null;
         for each(_loc2_ in this._views)
         {
...
class ItemSet#3111
{
   ...
   function ItemSet#3111(param1:ItemWrapper)
   {
      super();
      this.item = param1;
   }
