package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class InfoEntitiesFrame implements Frame
   {
      ...
      private function movementHandler(param1:Number) : void
      {
      ...
      private function removeElementHandler(param1:Number) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
      ...
      private function mouseOverHandler(param1:Number) : void
      {
         var _loc2_:DisplayedEntity = this.getEntity(param1);
         if(_loc2_ != null)
         {
      ...
      private function mouseOutHandler(param1:Number) : void
      {
         var _loc2_:DisplayedEntity = this.getEntity(param1);
         if(_loc2_ != null)
         {
      ...
      private function getEntity(param1:Number) : DisplayedEntity
      {
         var _loc2_:int = 0;
      ...
      private function addEntity(param1:Number, param2:String, param3:String = "") : void
      {
         ...
         {
            _loc4_ = new Label();
            _loc4_.css = new Uri(XmlConfig.getInstance().getEntry("config.ui.skin") + "css/normal2.css");
            if(param3 != "")
            {
            ...
            if(param1 == PlayedCharacterApi.getInstance().id())
            {
               _loc4_.colorText = XmlConfig.getInstance().getEntry("colors.tooltip.text.orange");
            }
      ...
      private function getBounds(param1:Number) : IRectangle
      {
...
class DisplayedEntity
{
   ...
   function DisplayedEntity(param1:Number = 0, param2:Label = null, param3:IRectangle = null, param4:String = "")
   {
      super();
