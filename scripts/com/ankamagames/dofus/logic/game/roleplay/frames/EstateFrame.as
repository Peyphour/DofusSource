      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is HouseToSellListMessage:
               ...
               KernelEventsManager.getInstance().processCallback(RoleplayHookList.EstateToSellList,this._estateList,_loc2_.pageIndex,_loc2_.totalPage,this._estateType);
               return true;
            case param1 is PaddockToSellListMessage:
               ...
               KernelEventsManager.getInstance().processCallback(RoleplayHookList.EstateToSellList,this._estateList,_loc3_.pageIndex,_loc3_.totalPage,this._estateType);
               return true;
