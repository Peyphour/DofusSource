package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayIntroductionFrame extends RegisteringFrame
   {
      ...
      private function onMapRenderStart(param1:MapsLoadingStartedMessage) : Boolean
      {
      ...
      private function onMapData(param1:MapComplementaryInformationsDataMessage) : Boolean
      {
         ...
         if(_loc2_ && IEntity(_loc2_).position && IEntity(_loc2_).position.cellId == START_CELL_ID)
         {
      ...
      private function changeWorldVisibility(param1:Boolean) : void
      {
         Atouin.getInstance().worldContainer.visible = param1;
      }
      ...
      protected function onSpawnEntityFailed(param1:Event) : void
      {
         this.changeWorldVisibility(true);
         this.setPlayerVisibility(true);
      }
