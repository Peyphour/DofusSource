package com.ankamagames.dofus.logic.common.frames
{
   ...
   public class DisconnectionHandlerFrame implements Frame
   {
      ...
      private var _mustShowSteamLoginInterface:Boolean = false;
      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is OpenPopupAction:
               ...
               return true;
            case param1 is ShowSteamLoginInterfaceAction:
               this._mustShowSteamLoginInterface = true;
               return true;
            default:
               return false;
         }
      ...
      public function get mustShowSteamLoginInterface() : Boolean
      {
         return this._mustShowSteamLoginInterface;
      }
   }
}
