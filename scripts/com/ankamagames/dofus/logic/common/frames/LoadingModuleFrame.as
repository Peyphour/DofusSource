      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            case param1 is ModuleLoadedMessage:
               ...
               this._loadingScreen.log(ModuleLoadedMessage(param1).moduleName + " script loaded " + (!!_loc2_?"":"UNTRUSTED module"),!!_loc2_?uint(LoadingScreen.IMPORTANT):uint(LoadingScreen.WARNING));
               return true;
            ...
            case param1 is ModuleRessourceLoadFailedMessage:
               ...
               this._loadingScreen.log("Module " + _loc3_.moduleName + " : Cannot load " + _loc3_.uri,!!_loc3_.isImportant?uint(LoadingScreen.ERROR):uint(LoadingScreen.WARNING));
