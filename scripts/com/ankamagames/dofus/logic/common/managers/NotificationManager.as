package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class NotificationManager
   {
      ...
      private var _notificationList:Vector.<Notification#3102>;
      
      public function NotificationManager(param1:PrivateClass#3102)
      {
         super();
         this._notificationList = new Vector.<Notification#3102>();
      }
      ...
      public static function getInstance() : NotificationManager
      {
         if(_self == null)
         {
            _self = new NotificationManager(new PrivateClass#3102());
         }
         return _self;
      }
      ...
      {
         var _loc4_:Notification = new Notification#3102();
         _loc4_.title = param1;
      ...
      public function prepareNotification(param1:String, param2:String, param3:uint = 0, param4:String = "", param5:Boolean = false, param6:Boolean = false) : uint
      {
         var _loc7_:Notification = new Notification#3102();
         _loc7_.title = param1;
         _loc7_.contentText = param2;
         _loc7_.type = param3;
         _loc7_.name = param4;
         _loc7_.refreshWithoutCallback = param6;
         return this._notificationList.push(_loc7_) - 1;
      }
      ...
      public function sendNotification(param1:int = -1) : void
      {
         ...
         {
            this.openNotification(this._notificationList[param1] as Notification#3102);
      ...
      private function getNotification(param1:uint) : Notification#3102
      {
...
class PrivateClass#3102
{
    
   
   function PrivateClass#3102()
   {
      super();
   }
}
