package com.ankamagames.dofus.network.messages.game.context.roleplay.houses
{
   ...
   public class HouseSellFromInsideRequestMessage extends HouseSellRequestMessage implements INetworkMessage
   {
      ...
      public function initHouseSellFromInsideRequestMessage(param1:uint = 0, param2:Boolean = false) : HouseSellFromInsideRequestMessage
      {
         super.initHouseSellRequestMessage(param1,param2);
