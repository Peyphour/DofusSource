package com.ankamagames.dofus.network
{
   ...
   public class MessageReceiver implements RawDataParser
   {
      ...
      
      {
         ...
         _messagesTypes[6616] = SubscriptionUpdateMessage;
         ...
         _messagesTypes[6640] = GameRolePlayArenaUpdatePlayerInfosWithTeamMessage;
         ...
         _messagesTypes[6654] = SpellModifySuccessMessage;
         _messagesTypes[6653] = SpellModifyFailureMessage;
         ...
         _messagesTypes[6614] = IdolsPresetUseResultMessage;
      ...
      public static function register() : void
      {
         ...
         StoreDataManager.getInstance().registerClass(new SubscriptionUpdateMessage(),true,true);
         ...
         StoreDataManager.getInstance().registerClass(new GameRolePlayArenaUpdatePlayerInfosWithTeamMessage(),true,true);
         ...
         StoreDataManager.getInstance().registerClass(new SpellModifySuccessMessage(),true,true);
         StoreDataManager.getInstance().registerClass(new SpellModifyFailureMessage(),true,true);
         ...
         StoreDataManager.getInstance().registerClass(new IdolsPresetUseResultMessage(),true,true);
