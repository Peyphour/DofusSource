package com.ankamagames.dofus.console.moduleLogger
{
   ...
   public final class ConsoleIcon extends Sprite
   {
      ...
      public function ConsoleIcon(param1:String, param2:int = 16, param3:String = "", param4:ConsoleIconList = null)
      {
         super();
         this._size = param2;
         if(_assets[param1])
         ...
         if(param3.length > 0)
         {
            this._tooltipName = "console_" + param1;
      ...
      {
         if(param1.uiTarget.name == "tooltip_" + this._tooltipName)
         {
            Berilia.getInstance().removeEventListener(UiRenderEvent.UIRenderComplete,this.onUiLoaded);
            param1.uiTarget.x = x + width + 5;
            param1.uiTarget.y = y;
            parent.addChild(param1.uiTarget);
         }
      }
