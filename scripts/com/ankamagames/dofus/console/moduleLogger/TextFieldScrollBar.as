package com.ankamagames.dofus.console.moduleLogger
{
   ...
   public final class TextFieldScrollBar extends Sprite
   {
      ...
      public function updateScrolling() : void
      {
         ...
         {
            _loc1_ = !!this._textField.wordWrap?uint(this.textFieldNumLines):uint(this._lines.length);
      ...
      {
         var _loc2_:uint = !!this._textField.wordWrap?uint(this.textFieldNumLines):uint(this._lines.length);
         if(param1 == -1)
         {
            param1 = this._scroll;
         }
      ...
      {
         var _loc1_:int = !!this._textField.wordWrap?int(this.textFieldNumLines):int(this._lines.length);
         ...
         var _loc5_:uint = this._textField.numLines - 1;
         var _loc6_:Rectangle = this._textField.getCharBoundaries(this._textField.getLineOffset(this._textField.numLines - 1));
         if(_loc6_ && _loc6_.y + _loc6_.height + Math.abs(this._textField.getLineMetrics(_loc5_).leading) > this._textField.height)
         {
            this._textField.htmlText = !!this._textField.wordWrap?this.checkSpan(_loc3_.slice(_loc2_ + 1).join("\n"),_loc2_ + 1):_loc3_.slice(_loc2_ + 1).join("\n");
         }
         this._scroll = _loc1_;
      ...
      {
         var _loc1_:uint = !!this._textField.wordWrap?uint(this.textFieldNumLines):uint(this._lines.length);
