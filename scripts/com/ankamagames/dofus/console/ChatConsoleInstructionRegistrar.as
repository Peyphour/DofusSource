package com.ankamagames.dofus.console
{
   ...
   public class ChatConsoleInstructionRegistrar implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(param1:ConsoleHandler) : void
      {
         ...
         param1.addHandler(["fps"],new BenchmarkInstructionHandler());
         ...
         {
            param1.addHandler(["savereplaylog","sd","colorui","coloruilist","coloruisave","coloruireset"],new MiscInstructionHandler());
         }
         else
         {
            param1.addHandler(["savereplaylog","colorui","coloruilist","coloruisave","coloruireset"],new MiscInstructionHandler());
         }
