package com.ankamagames.dofus.console
{
   ...
   public class DebugConsoleInstructionRegistar implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(param1:ConsoleHandler) : void
      {
         ...
         param1.addHandler(["enable169background","enable169","displaymap","displaymapdebug","getmapcoord","getmapid","testatouin","mapid","showcellid","playerjump","showtransitions","groundcache","removeblackbars","setmaprenderscale","capturemap","tutofx","debugmapwide","debugwidescreen","setfrustum","setclientwindowsize","togglebottomuis"],new DisplayMapInstructionHandler());
         param1.addHandler(["clearscene","clearentities","countentities"],new ClearSceneInstructionHandler());
         param1.addHandler(["inspector","uiinspector","inspectuielement","autoreloadui","changefonttype","resetuisavedusermodification","getthemefingerprint","inspectuielementsos","modulelist","loadui","unloadui","clearuicache","clearthemedata","setuiscale","useuicache","uilist","reloadui","getmoduleinfo","chatoutput","debugwebreader","debugvisionneuse","loadprotoxml","clearcsscache","cleartooltipcache","showarrow","texturebitmapcache"],new UiHandlerInstructionHandler());
         ...
         param1.addHandler(["savereplaylog","parallelsequenceteststart","log","i18nsize","newdofus","clear","config","clearwebcache","geteventmodeparams","setquality","lowdefskin","copylog","synchrosequence","throw","debugmouseover","idletime","setmonsterspeed","sosloglevel","sostarget","debugmodule"],new MiscInstructionHandler());
         param1.addHandler(["additem","looklike","relook"],new TiphonInstructionHandler());
         ...
         param1.addHandler(["addmovingcharacter","switchupdatemode","setanimation","setdirection","memorylog","bot-spectator","bot-fight","tiphon-error","fps","fpsmanager","tacticmode","chainteleport"],new BenchmarkInstructionHandler());
