      ...
      public function onHook(param1:Hook, param2:Array) : void
      {
         ...
         switch(param1.name)
         {
            ...
            case BeriliaHookList.MouseClick.name:
               _loc5_ = param2[0];
               if(_loc5_ && _loc5_ is FrustumShape && StatsAction.exists(StatisticTypeEnum.STEP2430_GO_TO_NEXT_MAP))
               {
               ...
               else if(_loc5_ && _loc5_ is AnimatedCharacter && param2[0].id != PlayedCharacterManager.getInstance().id)
               {
