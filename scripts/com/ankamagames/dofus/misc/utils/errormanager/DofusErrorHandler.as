package com.ankamagames.dofus.misc.utils.errormanager
{
   ...
   public class DofusErrorHandler
   {
      ...
      {
         var _loc1_:CustomSharedObject = CustomSharedObject.getLocal("BugReport");
         return _loc1_.data && _loc1_.data.force;
      }
      
      public static function set manualActivation(param1:Boolean) : void
      {
         var _loc2_:CustomSharedObject = CustomSharedObject.getLocal("BugReport");
         if(!_loc2_.data)
         {
            _loc2_.data = {};
         }
         _loc2_.data.force = param1;
         _loc2_.flush();
      }
      ...
      {
         var _loc1_:CustomSharedObject = CustomSharedObject.getLocal("BugReport");
         if(File.applicationDirectory.resolvePath("debug").exists || File.applicationDirectory.resolvePath("debug.txt").exists || _loc1_.data && _loc1_.data.force)
         {
