package com.ankamagames.dofus.misc.utils.errormanager
{
   ...
   public class WebServiceDataHandler extends EventDispatcher
   {
      ...
      public function WebServiceDataHandler(param1:PrivateClass#3065)
      {
      ...
      public static function getInstance() : WebServiceDataHandler
      {
         if(_self == null)
         {
            _self = new WebServiceDataHandler(new PrivateClass#3065());
         }
         return _self;
      }
      ...
      public function cleanStacktrace(param1:String) : String
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc6_ = /^(.*?\[)(.*?)((\/modules\/Ankama_|\/com\/ankama).*?)(:?[0-9]*?)(\].*?)/g;
...
class PrivateClass#3065
{
    
   
   function PrivateClass#3065()
   {
      super();
   }
}
