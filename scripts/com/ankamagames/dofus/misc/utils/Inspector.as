package com.ankamagames.dofus.misc.utils
{
   ...
   public class Inspector
   {
      ...
      public function set hierachicalMode(param1:Boolean) : void
      {
         this._hierachicalMode = param1;
      }
      ...
      private function getDeepestObject(param1:DisplayObject) : DisplayObject
      {
         var _loc3_:DisplayObject = null;
         var _loc4_:DisplayObject = null;
         this._underPoint.x = StageShareManager.mouseX;
         this._underPoint.y = StageShareManager.mouseY;
         var _loc2_:Array = StageShareManager.stage.getObjectsUnderPoint(this._underPoint);
         for each(_loc3_ in _loc2_)
         {
            _loc4_ = _loc3_;
            while(_loc4_ && !(_loc4_ is Stage) && _loc4_.parent)
            {
               if(_loc4_ == param1)
               {
                  return _loc3_;
      ...
      private function findSameLevelElements() : Vector.<InteractiveItem>
      {
         var _loc2_:InteractiveItem = null;
         var _loc4_:DisplayObject = null;
         var _loc1_:Vector.<InteractiveItem> = new Vector.<InteractiveItem>();
         this._underPoint.x = StageShareManager.mouseX;
         this._underPoint.y = StageShareManager.mouseY;
         var _loc3_:Array = StageShareManager.stage.getObjectsUnderPoint(this._underPoint);
         for each(_loc4_ in _loc3_)
         {
            while(_loc4_ && !(_loc4_ is Stage) && _loc4_.parent)
            {
               _loc2_ = this.cast(_loc4_);
               if(_loc2_)
               {
                  _loc1_.push(_loc2_);
                  break;
      ...
      private function cast(param1:DisplayObject) : InteractiveItem
      {
         var _loc2_:InteractiveItem = null;
         switch(true)
         {
...
class InteractiveItemUi extends InteractiveItem
{
   ...
   private function djb2(param1:String) : int
   {
      var _loc2_:int = 5381;
      var _loc3_:int = 0;
   ...
   private function hashStringToColor(param1:String) : String
   {
      var _loc2_:int = this.djb2(param1);
      var _loc3_:* = (_loc2_ & 16711680) >> 16;
      var _loc4_:* = (_loc2_ & 65280) >> 8;
      var _loc5_:* = _loc2_ & 255;
      return "#" + ("0" + _loc3_.toString(16) as String).substr(-2) + ("0" + _loc4_.toString(16) as String).substr(-2) + ("0" + _loc5_.toString(16) as String).substr(-2);
   }
   ...
   override public function tooltip() : String
   {
      ...
      var _loc5_:Vector.<BeriliaUiElementSound> = null;
      var _loc6_:BeriliaUiElementSound = null;
      var _loc1_:* = "";
      var _loc2_:String = "#0";
      ...
      {
         _loc4_ = getQualifiedClassName(target).split("::").pop();
         _loc1_ = _loc1_ + ("<b><font color=\'#964D8C\'>Composant </font><font color=\'" + this.hashStringToColor(_loc4_) + "\' >" + _loc4_ + "</font></b><br/>");
         _loc1_ = _loc1_ + ("<b>Nom : </b><font color=\'" + _loc2_ + "\'>" + target.name + "</font><br/>");
         switch(true)
         {
            case target is TextureBase:
               _loc1_ = _loc1_ + ("<b>Chemin : </b>" + TextureBase(target).uri + "<br/>");
               break;
            case target is Label:
               _loc1_ = _loc1_ + ("<b>Css : </b>" + Label(target).css + "<br/>");
               _loc1_ = _loc1_ + ("<b>Classe css : </b>" + Label(target).cssClass + "<br/>");
               break;
            case target is Slot:
               _loc1_ = _loc1_ + ("<b>emptyTexture : </b>" + Slot(target).emptyTexture + "<br/>");
               _loc1_ = _loc1_ + ("<b>acceptDragTexture : </b>" + Slot(target).acceptDragTexture + "<br/>");
               _loc1_ = _loc1_ + ("<b>refuseDragTexture : </b>" + Slot(target).refuseDragTexture + "<br/>");
         }
         _loc5_ = UiSoundManager.getInstance().getAllSoundUiElement(target as GraphicContainer);
         _loc1_ = _loc1_ + ("<b>Sons : </b>" + (!!_loc5_.length?"":"Aucun") + "");
         if(_loc5_.length)
         {
            for each(_loc6_ in _loc5_)
            {
               _loc1_ = _loc1_ + ("<br/>&nbsp;&nbsp;&nbsp; - " + _loc6_.hook + " : " + _loc6_.file);
            }
         }
      }
      return _loc1_;
