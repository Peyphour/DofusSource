package com.ankamagames.dofus.misc.utils.mapeditor
{
   ...
   public class MapEditorManager
   {
      ...
      private function onNewData(param1:MapEditorDataEvent) : void
      {
         ...
         switch(param1.data.type)
         {
            ...
            case MapEditorMessage.MESSAGE_TYPE_NPC:
               ...
               _loc7_.initMapComplementaryInformationsDataMessage(!!_loc8_?uint(_loc8_.id):uint(0),_loc4_,new Vector.<HouseInformations>(),_loc6_,new Vector.<InteractiveElement>(),new Vector.<StatedElement>(),new Vector.<MapObstacle>(),new Vector.<FightCommonInformations>());
      ...
      private function onMapRenderEnd(param1:RenderMapEvent) : void
      {
         ...
         if(param1.renderId == this._currentRenderId)
         {
