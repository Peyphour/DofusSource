package com.ankamagames.dofus.misc.utils
{
   ...
   public class CustomLoadingScreenManager
   {
      ...
      public function loadCustomScreenList(param1:String = null) : void
      {
         var _loc3_:Uri = null;
         var _loc2_:String = XmlConfig.getInstance().getEntry("config.lang.current");
         var _loc4_:String = XmlConfig.getInstance().getEntry("config.customLoadingScreen");
         _loc4_ = _loc4_.split("{lang}").join(_loc2_);
         _loc4_ = _loc4_.split("{nickname}").join(param1 == null?"":"nickname=" + param1);
