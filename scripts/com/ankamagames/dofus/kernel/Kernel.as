package com.ankamagames.dofus.kernel
{
   ...
   import com.ankamagames.dofus.logic.connection.actions.ShowSteamLoginInterfaceAction;
   ...
   public class Kernel
   {
      ...
      public function init(param1:Stage, param2:DisplayObject) : void
      {
         ...
         if(AirScanner.hasAir() && BuildInfos.BUILD_TYPE != BuildTypeEnum.DEBUG)
         {
            try
            {
      ...
      public function reset(param1:Array = null, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(SteamManager.hasSteamApi() && SteamManager.getInstance().isSteamEmbed())
         {
            ...
            param1.push(new ShowSteamLoginInterfaceAction());
         }
      ...
      public function initOptions() : void
      {
         ...
         _loc1_.pngPathOverride = LangManager.getInstance().getEntry("config.gfx.path.world.pngOverride");
         ...
         if(_loc1_.pngPathOverride.charAt(0) == "!")
         {
            _loc1_.pngPathOverride = "";
         }
