package com.ankamagames.dofus.kernel.sound
{
   ...
   public class SoundManager
   {
      ...
      public function setMusicVolume(param1:Number) : void
      {
         ...
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_MUSIC_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_FIGHT_MUSIC_ID,param1 * this._globalVolume);
      }
      ...
      public function setSoundVolume(param1:Number) : void
      {
         ...
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_UI_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_BARKS_ID,param1 * this._globalVolume);
      }
      ...
      public function setAmbienceVolume(param1:Number) : void
      {
         ...
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_AMBIENT_2D_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_AMBIENT_3D_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_BARKS_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_FIGHT_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_GFX_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_NPC_FOLEYS_ID,param1 * this._globalVolume);
         this.manager.setBusVolume(TubulSoundConfiguration.BUS_SFX_ID,param1 * this._globalVolume);
      }
      ...
      private function onPropertyChanged(param1:PropertyChangeEvent) : void
      {
         switch(param1.propertyName)
         {
            ...
            case "volumeAmbientSound":
               ...
               break;
            case "globalVolume":
               this._globalVolume = param1.propertyValue;
