package com.ankamagames.dofus.externalnotification
{
   ...
   public class ExternalNotificationManager
   {
      ...
      public function ExternalNotificationManager(param1:PrivateClass#3106)
      {
      ...
      public static function getInstance() : ExternalNotificationManager
      {
         if(!_instance)
         {
            _instance = new ExternalNotificationManager(new PrivateClass#3106());
         }
         return _instance;
      }
      ...
      private function hasNotificationData(param1:int) : Boolean
      {
         ...
         if(param1 > this._nbGeneralEvents)
         {
            return true;
         }
      ...
      private function synchronizeMultiAccountOptions() : void
      {
         ...
         for(_loc2_ in this._notificationsOptions)
         {
            _loc1_.push({
               "notifType":_loc2_,
               "multi":this._notificationsOptions[_loc2_].multi
            });
         }
         if(!this._isMaster)
         {
      ...
      public function updateAllMultiAccountOptions(param1:Array) : void
      {
         ...
         {
            if(_loc2_.multi != null)
            {
               this.updateMultiAccountOption(_loc2_.notifType,_loc2_.multi);
            }
         }
         if(this._isMaster)
         {
      ...
      {
         return !!this.hasNotificationData(param1)?Boolean(this._notificationsOptions[param1].sound):true;
      }
      
      public function notificationNotify(param1:int) : Boolean
      {
         return !!this.hasNotificationData(param1)?Boolean(this._notificationsOptions[param1].notify):false;
      }
      ...
      private function onConnectionStatus(param1:StatusEvent) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:uint = 0;
         if(param1.currentTarget == this._pingConnection)
         {
            _loc2_ = this._pingSlavesIds.shift();
            if(param1.level == "error")
            {
               this.unregisterSlave(_loc2_);
            }
            if(this._pingSlavesIds.length == 0)
            {
               if(this._slavesIds.length == 0)
               {
                  _loc4_ = this._waitingRequests.length;
                  _loc3_ = 0;
                  while(_loc3_ < _loc4_)
                  {
                     this._buffer.push(this._waitingRequests[_loc3_]);
                     this._timeOut.reset();
                     this._timeOut.start();
                     _loc3_++;
                  }
      ...
      private function pingSlaves() : void
      {
         ...
         var _loc2_:uint = this._slavesIds.length;
         _loc1_ = 0;
         while(_loc1_ < _loc2_)
         {
            try
            {
               this._pingConnection.send.apply(this,[this.CONNECTION_ID + ".ping." + this._slavesIds[_loc1_],"ping"]);
            }
            catch(e:Error)
            {
            }
      ...
      public function handleNotificationRequest(param1:Object) : void
      {
         ...
         if(this._isMaster)
         {
            if(this.hasNotificationData(_loc2_.notificationType) && this._notificationsOptions[_loc2_.notificationType].multi == false && this._slavesIds.length)
            {
               this._waitingRequests.push(_loc2_);
      ...
      {
         var _loc2_:ExternalNotificationWindow = new ExternalNotificationWindow(param1,this._nativeWinOpts);
         this._notificationsList.push(_loc2_);
      }
      
      public function addNotification(param1:ExternalNotificationWindow) : void
      {
         this.setNotificationCoordinates(param1);
         this.showExternalNotification(param1);
         if(this._playSound)
         {
...
class PrivateClass#3106
{
    
   
   function PrivateClass#3106()
   {
      super();
   }
}
