package com.ankamagames.jerakine.pathfinding
{
   ...
   public class Pathfinding
   {
      ...
      public static function findPath(param1:IDataMapProvider, param2:MapPoint, param3:MapPoint, param4:Boolean = true, param5:Boolean = true, param6:Function = null, param7:Array = null, param8:Boolean = false, param9:Boolean = true) : MovementPath
      {
         return new Pathfinding().processFindPath(param1,param2,param3,param4,param5,param6,param7,param8,param9);
      }
      
      public function processFindPath(param1:IDataMapProvider, param2:MapPoint, param3:MapPoint, param4:Boolean = true, param5:Boolean = true, param6:Function = null, param7:Array = null, param8:Boolean = false, param9:Boolean = true) : MovementPath
      {
            ...
            while(_loc3_ < this._nowY + 2)
            {
               ...
               while(_loc5_ < this._nowX + 2)
               {
                  if(_loc3_ >= _minY && _loc3_ < _maxY && _loc5_ >= _minX && _loc5_ < _maxX && !(_loc3_ == this._nowY && _loc5_ == this._nowX) && (this._allowDiag || _loc3_ == this._nowY || _loc5_ == this._nowX && (this._bAllowDiagCornering || _loc3_ == this._nowY || _loc5_ == this._nowX || (this._map.pointMov(this._nowX,_loc3_,this._bAllowTroughEntity,this._previousCellId,this._endPoint.cellId,this._avoidObstacles) || this._map.pointMov(_loc5_,this._nowY,this._bAllowTroughEntity,this._previousCellId,this._endPoint.cellId,this._avoidObstacles)))))
                  {
                     ...
                     {
                        if(this._map.pointMov(_loc5_,_loc3_,this._bAllowTroughEntity,this._previousCellId,this._endPoint.cellId,this._avoidObstacles))
                        {
