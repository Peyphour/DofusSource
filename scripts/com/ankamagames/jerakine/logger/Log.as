package com.ankamagames.jerakine.logger
{
   ...
   public final class Log
   {
      ...
      public static function deactivateLevel(param1:uint, param2:Boolean) : void
      {
         var _loc3_:LogLogger = null;
         for each(_loc3_ in _loggers)
         {
            _loc3_.setLevelDectivation(param1,param2);
         }
      }
      
      public static function removeTargetType(param1:String) : *
      {
         var _loc2_:LoggingTarget = null;
         var _loc4_:int = 0;
