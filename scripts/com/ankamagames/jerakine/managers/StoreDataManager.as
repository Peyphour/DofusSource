package com.ankamagames.jerakine.managers
{
   ...
   public class StoreDataManager
   {
      ...
      public function getKeys(param1:DataStoreType) : Array
      {
         ...
         if(param1.persistant)
         {
            ...
            {
               case DataStoreEnum.LOCATION_LOCAL:
                  _loc4_ = this.getSharedObject(param1.category);
                  _loc3_ = _loc4_.data;
                  break;
               case DataStoreEnum.LOCATION_SERVER:
            }
         }
         else if(this._aData[param1.category] != null)
         {
            _loc3_ = this._aData[param1.category];
         }
         if(_loc3_)
         {
