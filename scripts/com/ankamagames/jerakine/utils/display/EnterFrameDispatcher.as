package com.ankamagames.jerakine.utils.display
{
   ...
   public class EnterFrameDispatcher
   {
      ...
      public static function addEventListener(param1:Function, param2:String, param3:uint = 4.294967295E9) : void
      {
         ...
         {
            _controledListeners[param1] = new ControledEnterFrameListener(param2,param1,param3 > 0?uint(1000 / param3):uint(0),!!_listenerUp?uint(_currentTime):uint(getTimer()));
            if(!_listenerUp)
            {
      ...
      {
         return _controledListeners[param1] != null || _realTimeListeners[param1] != null;
      }
