package com.ankamagames.jerakine.utils.misc
{
   ...
   public class DescribeTypeCache
   {
      ...
      public static function getVariableAndAccessorType(param1:Object) : Dictionary
      {
         var _loc5_:XML = null;
         var _loc6_:XML = null;
         var _loc2_:String = getQualifiedClassName(param1);
         if(_variablesAndAccessorType[_loc2_])
         {
            return _variablesAndAccessorType[_loc2_];
         }
         var _loc3_:XML = typeDescription(param1);
         var _loc4_:Dictionary = new Dictionary();
         for each(_loc5_ in _loc3_..accessor)
         {
            if(_loc5_.@access.toString() != "readOnly")
            {
         ...
         _variablesAndAccessorType[_loc2_] = _loc4_;
         return _loc4_;
      }
