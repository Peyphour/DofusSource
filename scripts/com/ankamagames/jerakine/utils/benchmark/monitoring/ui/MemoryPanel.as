package com.ankamagames.jerakine.utils.benchmark.monitoring.ui
{
   ...
   public class MemoryPanel extends Sprite
   {
      ...
      private function drawGraphValue(param1:Vector.<Number>, param2:Vector.<Number>, param3:uint) : void
      {
         ...
         var _loc6_:Number = param2 == null?Number(MAX_THEO_VALUE):Number(param2[param1.length - 1]);
         _loc5_ = this.getGraphValue(param1,param1.length - 1,_loc6_);
         if(param1.length >= 2)
         {
            _loc7_ = param2 == null?Number(MAX_THEO_VALUE):Number(param2[param1.length - 2]);
      ...
      private function drawLine(param1:Vector.<Number>, param2:Vector.<Number>, param3:uint = 16711680) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            _loc4_ = _loc6_ < FpsManagerConst.BOX_WIDTH?int(FpsManagerConst.BOX_WIDTH - _loc6_ + _loc7_):int(_loc7_);
            _loc8_ = param2 == null?Number(MAX_THEO_VALUE):Number(param2[_loc7_]);
            _loc5_ = this.getGraphValue(param1,_loc7_,_loc8_);
            if(_loc7_ != 0)
            {
               _loc9_ = param2 == null?Number(MAX_THEO_VALUE):Number(param2[_loc7_ - 1]);
