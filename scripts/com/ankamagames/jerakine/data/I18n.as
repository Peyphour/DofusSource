package com.ankamagames.jerakine.data
{
   public class I18n extends AbstractDataManager
   {
      ...
      public static function getUnDiacriticalText(param1:uint, param2:Array = null, param3:String = "%") : String
      {
         if(!param1)
         {
            return null;
         }
         var _loc4_:String = I18nFileAccessor.getInstance().getUnDiacriticalText(param1);
         if(_loc4_ == null || _loc4_ == "null")
         {
            return "[UNKNOWN_TEXT_ID_" + param1 + "]";
         }
      ...
      public static function replaceParams(param1:String, param2:Array, param3:String) : String
      {
         ...
         {
            param1 = param1.replace(param3 + _loc4_,param2[_loc4_ - 1]);
            _loc4_++;
         }
         return param1;
      }
