...
{
   public class GameActionsActionsDeliveredKrosmagaKamas
   {
      ...
      public function GameActionsActionsDeliveredKrosmagaKamas()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredKrosmagaKamas {\n");
