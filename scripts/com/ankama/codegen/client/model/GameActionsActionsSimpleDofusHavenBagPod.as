...
{
   public class GameActionsActionsSimpleDofusHavenBagPod
   {
      ...
      public function GameActionsActionsSimpleDofusHavenBagPod()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsSimpleDofusHavenBagPod {\n");
