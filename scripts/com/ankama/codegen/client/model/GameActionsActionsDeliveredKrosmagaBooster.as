...
{
   public class GameActionsActionsDeliveredKrosmagaBooster
   {
      ...
      public function GameActionsActionsDeliveredKrosmagaBooster()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredKrosmagaBooster {\n");
