...
{
   public class GameActionsActionsDeliveredDofusHavenBagRoom
   {
      ...
      public function GameActionsActionsDeliveredDofusHavenBagRoom()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredDofusHavenBagRoom {\n");
