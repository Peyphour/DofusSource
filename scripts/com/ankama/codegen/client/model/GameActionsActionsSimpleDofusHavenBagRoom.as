...
{
   public class GameActionsActionsSimpleDofusHavenBagRoom
   {
      ...
      public function GameActionsActionsSimpleDofusHavenBagRoom()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsSimpleDofusHavenBagRoom {\n");
