...
{
   public class GameActionsActionsDeliveredKrosmagaCard
   {
      ...
      public function GameActionsActionsDeliveredKrosmagaCard()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredKrosmagaCard {\n");
