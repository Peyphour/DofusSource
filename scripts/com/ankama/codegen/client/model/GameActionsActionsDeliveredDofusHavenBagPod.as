...
{
   public class GameActionsActionsDeliveredDofusHavenBagPod
   {
      ...
      public function GameActionsActionsDeliveredDofusHavenBagPod()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredDofusHavenBagPod {\n");
