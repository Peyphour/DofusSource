...
{
   public class GameActionsActionsDeliveredCharacterAccountTransfer
   {
      ...
      public function GameActionsActionsDeliveredCharacterAccountTransfer()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredCharacterAccountTransfer {\n");
