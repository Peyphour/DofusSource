...
{
   public class GameActionsActionsDeliveredDofusHavenBagTheme
   {
      ...
      public function GameActionsActionsDeliveredDofusHavenBagTheme()
      {
         super();
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_.concat("class GameActionsActionsDeliveredDofusHavenBagTheme {\n");
