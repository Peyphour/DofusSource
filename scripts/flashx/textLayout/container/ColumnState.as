   ...
   public class ColumnState
   {
      ...
      tlf_internal function computeColumns() : void
      {
         ...
         if(this._blockProgression == BlockProgression.TB)
         {
            ...
            _loc10_ = this._compositionHeight > _loc12_ && !isNaN(this._compositionHeight)?Number(this._compositionHeight - _loc12_):Number(0);
         }
         else if(this._blockProgression == BlockProgression.RL)
         {
            ...
            _loc11_ = this._compositionWidth > _loc12_?Number(this._compositionWidth - _loc12_):Number(0);
