package flashx.textLayout.compose
{
   ...
   public class BaseCompose
   {
      ...
      private function composeBlockElement(param1:FlowGroupElement, param2:int) : Boolean
      {
         ...
         var _loc13_:ListItemElement = null;
         var _loc5_:int = 0;
         if(param2 != this._curElementStart + this._curElementOffset)
         {
            ...
            param2 = param2 + _loc3_.parentRelativeStart;
         }
         ...
         while(_loc5_ < param1.numChildren && (param2 <= this._stopComposePos || !this.parcelList.atLast()))
         {
            ...
            _loc11_ = _loc3_ as ParagraphElement;
            if(_loc11_)
            {
            ...
            param2 = param2 + _loc3_.textLength;
            _loc6_ = true;
            _loc5_++;
         }
         return true;
      ...
      {
         var _loc10_:int = 0;
         var _loc11_:FloatCompositionData = null;
         var _loc12_:InlineGraphicElement = null;
         ...
         var _loc4_:FlowLeafElement = this._textFlow.findLeaf(this._curLine.absoluteStart);
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            _loc10_ = this._curParcel.controller.numFloats;
            if(_loc10_)
            {
               while(_loc7_ < _loc10_)
               {
                  _loc11_ = this._curParcel.controller.getFloatAt(_loc7_);
                  if(_loc11_.columnIndex > this._curParcel.columnIndex)
                  {
                     break;
                  }
      ...
      protected function composeParagraphElementIntoLines() : Boolean
      {
         ...
         while(_loc1_)
         {
            ...
            _loc11_ = this._atColumnStart && this._curParaFormat.leadingModel != LeadingModel.BOX?Number(0):Number(this._curLine.spaceBefore);
            _loc12_ = !!this._atColumnStart?Number(0):Number(this._paragraphSpaceCarried);
         ...
         if(this._pushInFloats && this._pushInFloats.length > 0)
         {
            ...
            if(this._curLine.absoluteStart + this._curLine.textLength <= _loc8_)
            {
               ...
               while(_loc9_ >= 0)
               {
                  ...
                  {
                     _loc13_ = !!isNaN(this._lastLineDescent)?Number(0):Number(this._lastLineDescent);
      ...
      protected function composeFloat(param1:InlineGraphicElement, param2:Boolean) : Boolean
      {
         ...
         if(_loc10_)
         {
            ...
            _loc14_ = !!isNaN(this._lastLineDescent)?Number(0):Number(this._lastLineDescent);
      ...
      private function calculateFloatBounds(param1:InlineGraphicElement, param2:Boolean, param3:String) : Rectangle
      {
         ...
         if(param2)
         {
            ...
            _loc4_.y = param3 == Float.LEFT?Number(this._curParcel.y + _floatSlug.leftMargin + param1.getEffectivePaddingTop()):Number(this._curParcel.bottom - _floatSlug.rightMargin - param1.getEffectivePaddingBottom() - param1.elementHeight);
            _loc4_.width = param1.elementWidth;
            _loc4_.height = param1.elementHeight;
         }
         else
         {
            _loc4_.x = param3 == Float.LEFT?Number(this._curParcel.x + _floatSlug.leftMargin + param1.getEffectivePaddingLeft()):Number(this._curParcel.right - _floatSlug.rightMargin - param1.getEffectivePaddingRight() - param1.elementWidth);
      ...
      private function getRightSideGap(param1:TextFlowLine, param2:Boolean) : Number
      {
         ...
         var _loc5_:Number = _loc4_.direction == Direction.RTL?Number(_loc4_.paragraphStartIndent):Number(_loc4_.paragraphEndIndent);
         ...
         if(param3)
         {
            ...
            if(this._blockProgression == BlockProgression.TB)
            {
               if(!this._measuring)
               {
                  ...
                  {
                     _loc7_ = param3.textAlign == TextAlign.CENTER?Number(_loc9_ / 2):Number(_loc9_);
      ...
      protected function finishComposeLine(param1:TextLine, param2:TextLine) : void
      {
         ...
         var _loc7_:Number = this._atColumnStart && this._curLineLeadingModel != LeadingModel.BOX?Number(0):Number(this._curLine.spaceBefore);
         var _loc8_:Number = !!this._atColumnStart?Number(0):Number(this._paragraphSpaceCarried);
      ...
      {
         var _loc2_:Number = !!param1.measureWidth?Number(Number.MAX_VALUE):Number(param1.compositionWidth);
         ...
         this._controllerVisibleBoundsWidthTW = !!param1.measureWidth?int(int.MAX_VALUE):int(Twips.to(param1.compositionWidth));
         this._controllerVisibleBoundsHeightTW = !!param1.measureHeight?int(int.MAX_VALUE):int(Twips.to(param1.compositionHeight));
      }
