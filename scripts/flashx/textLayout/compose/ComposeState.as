      ...
      override protected function composeNextLine() : TextLine
      {
         ...
         if(_listItemElement && _listItemElement.getAbsoluteStart() == _curElementStart + _curElementOffset)
         {
            ...
            else
            {
               ...
               _loc4_ = TextFlowLine.createNumberLine(_listItemElement,_curParaElement,_flowComposer.swfContext,!!_loc7_?Number(_parcelList.rightMargin):Number(_parcelList.leftMargin));
            }
