package org.as3commons.bytecode.abc
{
   ...
   public class QualifiedName extends NamedMultiname
   {
      ...
      public function QualifiedName(param1:String, param2:LNamespace, param3:MultinameKind = null)
      {
         param3 = !!param3?param3:MultinameKind.QNAME;
         super(param3,param1);
         this.initQualifiedName(param2,param3);
      }
      
      protected function initQualifiedName(param1:LNamespace, param2:MultinameKind) : void
      {
      ...
      public function set nameSpace(param1:LNamespace) : void
      {
         this._namespace = param1;
      }
