package org.as3commons.bytecode.abc
{
   ...
   public final class ConstantPool implements IEquals, IConstantPool
   {
      ...
      public function getConstantPoolItemIndex(param1:ConstantKind, param2:*) : int
      {
         ...
         return _loc3_ is Array?_loc3_[1] is Dictionary?int(_loc3_[1][param2]):int(_loc3_[1].get(param2)):-1;
      }
      ...
      as3commons_bytecode function setNamespacePool(param1:Vector.<LNamespace>) : void
      {
      ...
      as3commons_bytecode function setNamespaceSetPool(param1:Vector.<NamespaceSet>) : void
      {
      ...
      as3commons_bytecode function setMultinamePool(param1:Vector.<BaseMultiname>) : void
      {
      ...
      as3commons_bytecode function setClassInfo(param1:Vector.<ClassInfo>) : void
      {
         this._classInfo = param1;
      }
      
      public function addMultiname(param1:BaseMultiname) : int
      {
      ...
      protected function validateMultiname(param1:BaseMultiname) : void
      {
      ...
      protected function validateNamespace(param1:LNamespace) : Boolean
      {
      ...
      private function addObject(param1:*, param2:Dictionary, param3:Object) : int
      {
         ...
         if(this._dupeCheck)
         {
            ...
            _loc5_ = _loc6_ != null?int(_loc6_):-1;
         }
         if(_loc5_ == -1)
         {
            if(!this.locked)
      ...
      public function getNamespacePosition(param1:LNamespace) : int
      {
         var _loc2_:int = -1;
      ...
      public function getNamespaceSetPosition(param1:NamespaceSet) : int
      {
         var _loc2_:int = -1;
      ...
      public function getMultinamePosition(param1:BaseMultiname) : int
      {
         var _loc2_:int = -1;
      ...
      public function addNamespace(param1:LNamespace) : int
      {
         return this.addObject(this._namespacePool,this._namespaceLookup,param1);
      }
      
      public function addNamespaceSet(param1:NamespaceSet) : int
      {
         var _loc2_:LNamespace = null;
      ...
      public function initializeLookups() : void
      {
         ...
         var _loc7_:LNamespace = null;
         var _loc8_:NamespaceSet = null;
         var _loc1_:int = 0;
      ...
      public function addToPool(param1:*, param2:*, param3:Object) : int
      {
         ...
         var _loc5_:int = _loc4_ != null?int(_loc4_):-1;
         if(_loc5_ > -1)
         {
            return _loc5_;
         }
