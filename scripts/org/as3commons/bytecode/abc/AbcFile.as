package org.as3commons.bytecode.abc
{
   ...
   public final class AbcFile
   {
      ...
      public function addMethodInfo(param1:MethodInfo) : int
      {
      ...
      public function addInstanceInfo(param1:InstanceInfo) : int
      {
      ...
      public function addScriptInfo(param1:ScriptInfo) : int
      {
      ...
      public function addMethodBody(param1:MethodBody) : int
      {
      ...
      as3commons_bytecode function setMethodInfo(param1:Vector.<MethodInfo>) : void
      {
      ...
      as3commons_bytecode function setInstanceInfo(param1:Vector.<InstanceInfo>) : void
      {
      ...
      as3commons_bytecode function setScriptInfo(param1:Vector.<ScriptInfo>) : void
      {
      ...
      as3commons_bytecode function setMethodBodies(param1:Vector.<MethodBody>) : void
      {
