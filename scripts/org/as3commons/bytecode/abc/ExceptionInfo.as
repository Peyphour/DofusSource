package org.as3commons.bytecode.abc
{
   ...
   public class ExceptionInfo implements ICloneable, IEquals
   {
      ...
      public function clone() : *
      {
         ...
         _loc1_.exceptionEnabledFromOpcode = this.exceptionEnabledFromOpcode.clone() as Op;
         _loc1_.exceptionEnabledToCodePosition = this.exceptionEnabledToCodePosition;
         _loc1_.exceptionEnabledToOpcode = this.exceptionEnabledToOpcode.clone() as Op;
         _loc1_.codePositionToJumpToOnException = this.codePositionToJumpToOnException;
         _loc1_.opcodeToJumpToOnException = this.opcodeToJumpToOnException.clone() as Op;
         _loc1_.exceptionType = this.exceptionType.clone() as QualifiedName;
         _loc1_.variableReceivingException = this.variableReceivingException.clone() as QualifiedName;
         return _loc1_;
      }
