package org.as3commons.bytecode.abc
{
   ...
   public final class MethodBody implements ICloneable, IEquals
   {
      ...
      public function addExceptionInfo(param1:ExceptionInfo) : uint
      {
      ...
      public function clone() : *
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Op = null;
         var _loc6_:JumpTargetData = null;
         var _loc7_:JumpTargetData = null;
         ...
         _loc1_.jumpTargets = new Vector.<JumpTargetData>();
         ...
         for each(_loc7_ in this.jumpTargets)
         {
            ...
            _loc6_ = new JumpTargetData(_loc1_.opcodes[_loc3_],_loc5_);
      ...
      public function equals(param1:Object) : Boolean
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:JumpTargetData = null;
