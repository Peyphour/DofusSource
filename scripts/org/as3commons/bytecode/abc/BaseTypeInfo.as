package org.as3commons.bytecode.abc
{
   ...
   public class BaseTypeInfo implements IEquals
   {
      ...
      public function addTrait(param1:TraitInfo) : void
      {
      ...
      public function removeTrait(param1:TraitInfo) : void
      {
      ...
      public function getMethodTraitByName(param1:String) : MethodTrait
      {
         ...
         var _loc2_:Vector.<TraitInfo> = this.methodTraits;
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_.traitMultiname.name == param1)
            {
      ...
      public function getTraitsByKind(param1:TraitKind) : Vector.<TraitInfo>
      {
      ...
      {
         var _loc3_:MethodTrait = null;
         var _loc1_:Vector.<TraitInfo> = this.methodTraits.concat(this.getterTraits).concat(this.setterTraits);
      ...
      public function equals(param1:Object) : Boolean
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:TraitInfo = null;
         var _loc6_:TraitInfo = null;
