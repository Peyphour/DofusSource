package nochump.util.zip
{
   ...
   public class ZipOutput
   {
      ...
      public function finish() : void
      {
         ...
         var _loc1_:uint = this._buf.position;
         var _loc2_:uint = 0;
      ...
      private function writeLOC(param1:ZipEntry) : void
      {
         ...
         this._buf.writeShort(param1.extra != null?int(param1.extra.length):0);
      ...
      private function writeCEN(param1:ZipEntry) : void
      {
         ...
         this._buf.writeShort(param1.name.length);
         this._buf.writeShort(param1.extra != null?int(param1.extra.length):0);
         this._buf.writeShort(param1.comment != null?int(param1.comment.length):0);
