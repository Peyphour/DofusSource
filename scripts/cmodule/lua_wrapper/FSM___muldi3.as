package cmodule.lua_wrapper
{
   ...
   public final class FSM___muldi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc3_ = int(li32(FSM___muldi3.ebp + 8));
         _loc4_ = _loc1_ >> 31;
         _loc5_ = int(li32(FSM___muldi3.ebp + 16));
         _loc6_ = _loc2_ >> 31;
         ...
         if(_loc7_ == 0)
         {
            if(_loc4_ == 0)
            {
               ...
               FSM___muldi3.esp = FSM___muldi3.esp - 4;
               FSM___muldi3.start();
               _loc3_ = int(FSM___muldi3.eax);
               _loc4_ = int(FSM___muldi3.edx);
               FSM___muldi3.esp = FSM___muldi3.esp + 8;
               if(_loc1_ != _loc2_)
               {
                  addr413:
         ...
         FSM___muldi3.esp = FSM___muldi3.esp - 4;
         FSM___muldi3.start();
         _loc5_ = int(FSM___muldi3.eax);
         _loc6_ = int(FSM___muldi3.edx);
