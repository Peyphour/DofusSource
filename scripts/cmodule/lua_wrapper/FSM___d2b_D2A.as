         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i0 != 0)
               {
                  ...
                  si32(this.i5,FSM___d2b_D2A + 4);
               }
               else
               {
                  this.i0 = FSM___d2b_D2A;
                  this.i5 = li32(FSM___d2b_D2A);
