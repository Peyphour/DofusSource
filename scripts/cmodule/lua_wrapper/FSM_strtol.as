package cmodule.lua_wrapper
{
   ...
   public final class FSM_strtol extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         var _loc8_:* = 0;
         var _loc9_:* = 0;
         FSM_strtol.esp = FSM_strtol.esp - 4;
         si32(FSM_strtol.ebp,FSM_strtol.esp);
         FSM_strtol.ebp = FSM_strtol.esp;
         FSM_strtol.esp = FSM_strtol.esp - 0;
         _loc1_ = 0;
         _loc2_ = li32(FSM_strtol);
         _loc3_ = int(li32(FSM_strtol.ebp + 8));
         _loc4_ = int(_loc3_);
         while(true)
         {
         ...
         while(true)
         {
            ...
            if(uint(_loc9_) >= uint(10))
            {
               ...
               {
                  _loc1_ = 34;
                  si32(_loc1_,FSM_strtol);
                  FSM_strtol.eax = _loc5_;
               }
               else if(_loc3_ == 0)
               {
                  _loc1_ = 22;
                  si32(_loc1_,FSM_strtol);
                  FSM_strtol.eax = _loc2_;
               }
               else
               {
                  _loc1_ = _loc1_ & 1;
                  ...
                  FSM_strtol.eax = _loc1_;
               }
               FSM_strtol.esp = FSM_strtol.ebp;
               FSM_strtol.ebp = li32(FSM_strtol.esp);
               FSM_strtol.esp = FSM_strtol.esp + 4;
               FSM_strtol.esp = FSM_strtol.esp + 4;
               return;
            }
