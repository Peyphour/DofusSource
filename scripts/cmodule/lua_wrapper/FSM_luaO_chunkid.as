package cmodule.lua_wrapper
{
   ...
   public final class FSM_luaO_chunkid extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         var _loc10_:* = 0;
         var _loc11_:int = 0;
         FSM_luaO_chunkid.esp = FSM_luaO_chunkid.esp - 4;
         si32(FSM_luaO_chunkid.ebp,FSM_luaO_chunkid.esp);
         FSM_luaO_chunkid.ebp = FSM_luaO_chunkid.esp;
         FSM_luaO_chunkid.esp = FSM_luaO_chunkid.esp - 32;
         _loc1_ = li32(FSM_luaO_chunkid.ebp + 12);
         _loc2_ = int(li8(_loc1_));
         _loc3_ = li32(FSM_luaO_chunkid.ebp + 8);
         _loc4_ = li32(FSM_luaO_chunkid.ebp + 16);
         _loc5_ = _loc3_;
         _loc6_ = _loc1_;
         if(_loc2_ != 64)
         {
            ...
            if(_loc7_ != 61)
            {
               ...
               {
                  _loc7_ = 1;
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -32);
                  _loc7_ = 0;
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -28);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -24);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -20);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -16);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -12);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -8);
                  si32(_loc7_,FSM_luaO_chunkid.ebp + -4);
                  _loc7_ = int(FSM_luaO_chunkid);
                  while(true)
                  {
                     _loc8_ = int(FSM_luaO_chunkid.ebp + -32);
                  ...
                  _loc7_ = int(FSM_luaO_chunkid.ebp + -32);
                  _loc8_ = _loc2_ & 224;
                  _loc8_ = int(_loc8_ >>> 3);
            ...
            addr394:
            FSM_luaO_chunkid.esp = FSM_luaO_chunkid.ebp;
            FSM_luaO_chunkid.ebp = li32(FSM_luaO_chunkid.esp);
            FSM_luaO_chunkid.esp = FSM_luaO_chunkid.esp + 4;
            FSM_luaO_chunkid.esp = FSM_luaO_chunkid.esp + 4;
            return;
         }
