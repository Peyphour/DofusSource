      ...
      override public final function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp = mstate.esp - 4;
               FSM_luaB_print.start();
            case 1:
               this.i0 = mstate.eax;
               this.i2 = this.i2 - this.i3;
               mstate.esp = mstate.esp + 8;
               this.i3 = FSM_luaB_print;
               this.i4 = this.i2 / 12;
               this.i5 = this.i1 + 8;
               while(true)
               {
            ...
            case 3:
               ...
               {
                  addr947:
                  this.i0 = li32(FSM_luaB_print + 96);
                  this.i0 = this.i0 + -1;
                  si32(this.i0,FSM_luaB_print + 96);
                  if(this.i0 <= -1)
                  {
                     this.i1 = li32(FSM_luaB_print + 112);
                     if(this.i0 >= this.i1)
                     {
                        this.i0 = 10;
                        this.i1 = li32(FSM_luaB_print + 88);
                        si8(this.i0,this.i1);
                        this.i0 = li32(FSM_luaB_print + 88);
                        this.i1 = li8(this.i0);
                        if(this.i1 != 10)
                        {
                           this.i1 = 0;
                           this.i0 = this.i0 + 1;
                           si32(this.i0,FSM_luaB_print + 88);
                           mstate.eax = this.i1;
                        }
                     }
                     this.i0 = FSM_luaB_print;
                     mstate.esp = mstate.esp - 8;
                     this.i0 = this.i0 + 88;
                     this.i1 = 10;
                     si32(this.i1,mstate.esp);
            ...
            case 7:
               ...
               if(this.i3 >= 2)
               {
                  this.i11 = li32(FSM_luaB_print + 96);
                  this.i11 = this.i11 + -1;
                  si32(this.i11,FSM_luaB_print + 96);
                  if(this.i11 <= -1)
                  {
                     this.i12 = li32(FSM_luaB_print + 112);
                     if(this.i11 >= this.i12)
                     {
                        this.i11 = 9;
                        this.i12 = li32(FSM_luaB_print + 88);
                        si8(this.i11,this.i12);
                        this.i11 = li32(FSM_luaB_print + 88);
                        this.i12 = li8(this.i11);
                        if(this.i12 != 10)
                        {
                           this.i11 = this.i11 + 1;
                           si32(this.i11,FSM_luaB_print + 88);
                           break;
                        }
                        this.i11 = FSM_luaB_print;
                        mstate.esp = mstate.esp - 8;
         ...
         this.i9 = li32(FSM_luaB_print + 144);
