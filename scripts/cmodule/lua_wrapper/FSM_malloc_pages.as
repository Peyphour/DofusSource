package cmodule.lua_wrapper
{
   ...
   public final class FSM_malloc_pages extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc1_ = int(li32(FSM_malloc_pages.ebp + 8));
         _loc1_ = int(_loc1_ + 4095);
         _loc2_ = int(li32(FSM_malloc_pages));
         _loc3_ = _loc1_ & -4096;
         if(_loc2_ != 0)
         {
            _loc1_ = int(_loc2_);
            while(true)
            {
               ...
               if(uint(_loc2_) >= uint(_loc3_))
               {
                  ...
                  {
                     _loc5_ = 2;
                     _loc6_ = int(li32(FSM_malloc_pages));
                     _loc7_ = _loc4_ >>> 12;
                     _loc8_ = int(_loc7_ - _loc6_);
                     _loc9_ = int(li32(FSM_malloc_pages));
                     _loc8_ = _loc8_ << 2;
                     ...
                     _loc2_ = int(li8(FSM_malloc_pages));
                     _loc2_ = _loc2_ ^ 1;
                     _loc2_ = _loc2_ & 1;
                     if(_loc2_ == 0)
                     {
            ...
            if(uint(_loc1_) >= uint(_loc6_))
            {
               ...
               if(_loc2_ == 0)
               {
                  ...
                  si32(_loc1_,FSM_malloc_pages);
                  _loc1_ = int(li32(FSM_malloc_pages));
                  _loc2_ = int(_loc7_ + 1);
